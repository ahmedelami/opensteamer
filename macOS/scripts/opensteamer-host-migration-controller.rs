...
const PRIOR_RETRY_PREFLIGHT_MODE: &str = "--verify-reviewed-prior-retry-state";
...
const PRIOR_V11_ACTIVE_TRANSACTION_NAME: &str = "active-migration-v11";
const PRIOR_V11_ACTIVE_TRANSACTION_PENDING_NAME: &str = ".active-migration-v11.pending";
const PRIOR_V11_ACTIVE_TRANSACTION_FINALIZING_NAME: &str = ".active-migration-v11.finalizing";
const PRIOR_V11_ACTIVE_TRANSACTION_LINEARIZED_NAME: &str = ".active-migration-v11.linearized";
const PRIOR_V11_EVIDENCE_PATH: &str =
    "/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v11-1785637636-18044";
const PRIOR_V11_ACTIVE_RECORD: &[u8] = b"/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v11-1785637636-18044\n";
const PRIOR_V11_ACTIVE_SHA256: &str =
    "f2c7d26372b9c3fe6c41408a320b7401031847b35406ddc50595972112d6e29c";
const PRIOR_V11_SOURCE_COMMIT: &str = "782f845529df161c6cbe61cc8c97b39f7537fc49";
const PRIOR_V11_SOURCE_TREE: &str = "b643e6fea140ec9ce4b3782a0ff50e39f4de4e8e";
const PRIOR_V11_FINAL_JOURNAL_SHA256: &str =
    "19cec66b77df4e25dc34a303ca8e1c5ec54c0b30dc39f5dbd0a49d5607e972c5";
const PRIOR_V11_FINAL_JOURNAL: &[u8] = br#"OPENSTEAMER_MIGRATION_JOURNAL_V11
STATE BEGUN
STATE BEGUN prior_v9_active_sha256=55c5936e520d65c2096811546357853e05064eca41553603793bea5843518559 prior_v9_journal_sha256=566504aa212b4b4ae627996859991c0aa8742f9fa5019145a9e73ca9c6ddf524 prior_v9_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v9_source_archive_sha256=0d0022af455d2d7a2d49c43025760ece421b9cdd0b33451fad55f338f9746202 prior_v9_source_commit=2ef1c9cbb972c0c138ae36bbe996eacda214113d prior_v10_active_sha256=af917e5ca70f533d1e78b62cf7bda66a682d2fd61dc2d1e337615f52e44ac02a prior_v10_journal_sha256=3d29812b215a1a765492ac76dd849454159170be618334ccfd08585c67371b0c prior_v10_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v10_source_archive_sha256=b742d38f5e21f8febbc6a436112de633cc15e34be9ecd698915b3231a253acb3 prior_v10_source_commit=a0a25f7010a1170330ad7ebd48d0e85839219af4 prior_v10_source_tree=98c0c0d230aa89f56121916f0ef158cf8c0563b1 prior_v10_provenance_sha256=7bea7b1f67a0a88467526b333e6a941302d160c8fe05393a3619ed398821bba6 prior_v10_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v10_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730
STATE PROVENANCE_VERIFIED commit=782f845529df161c6cbe61cc8c97b39f7537fc49 tree=b643e6fea140ec9ce4b3782a0ff50e39f4de4e8e
STATE LEGACY_SNAPSHOTTED
STATE NEW_STAGED
STATE PRECUTOVER_VERIFIED applications_device=16777230 applications_inode=4982341 launch_agents_device=16777230 launch_agents_inode=474668 precutover_available_bytes=3461914624 rollback_reserve_device=16777230 rollback_reserve_inode=20796192 rollback_reserve_bytes=8388608
STATE LEGACY_DISABLED
STATE LEGACY_STOPPED
STATE LOCK_HANDED_OFF
STATE NEW_INSTALLED
STATE NEW_BOOTSTRAPPED
STATE NEW_PID_OBSERVED log_offset=341 log_device=16777230 log_inode=20570513 pid=31913 runs=1 process_start=Sat%20Aug%20%201%2022%3A30%3A14%202026 nonce=864913757b4ff92721f694519c5bb71e614902fd6af1d0ec292bbeb541f2f24f lock_device=16777230 lock_inode=10835208
STATE ROLLBACK_STARTED legacy_disable_was_journaled=true rollback_mode=FullRestore
STATE NEW_STOPPED
STATE NEW_DESTINATIONS_CLEARED
STATE LEGACY_REENABLED
...
STATE ROLLED_BACK
"#;
const PRIOR_V11_FINAL_RESULT: &[u8] = b"result=rolled-back\nlegacy_launchd_disabled=false\nphysical_iphone_e2e=unavailable-not-claimed\n";
const PRIOR_V11_FINAL_RESULT_SHA256: &str =
    "434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301";
const PRIOR_V11_SOURCE_ARCHIVE_SIZE: u64 = 6_379_520;
const PRIOR_V11_SOURCE_ARCHIVE_SHA256: &str =
    "81fd74d1de17155109234469fa4da754783a6b1961ea93320d7932e21777748b";
const PRIOR_V11_PROVENANCE_SHA256: &str =
    "88918466881abe9db8b35956835e390d7de7265f7da1378da445190ab264785d";
const PRIOR_V11_PROVENANCE: &[u8] = br#"commit=782f845529df161c6cbe61cc8c97b39f7537fc49
tree=b643e6fea140ec9ce4b3782a0ff50e39f4de4e8e
remote=https://github.com/ahmedelami/opensteamer.git
upstream=origin/agent/auto-select-iphone-microphone
source_archive_sha256=81fd74d1de17155109234469fa4da754783a6b1961ea93320d7932e21777748b
package_resolved_sha256=161213e9507513e41f0acba0d7439fcf633b9d03d78c22b1e4b15fa9f83a01d9
"#;
const PRIOR_V11_LEGACY_MANIFEST_SHA256: &str =
    "2bdaddf99c5101a8f994d3916b44a66f6c8fcbd3c0cda1b3ae44694263d6971f";
const PRIOR_V11_LEGACY_XATTRS_SHA256: &str =
    "cc69a330ffd8dcb92e45bfa1b2f7163f749b2c1875bc2ead51f9ed50dd252ea8";
const PRIOR_V11_STAGED_HASHES_SHA256: &str =
    "078af99537f2699b14e8f44f9ae270aa621c88d39159645950fd3cc3a9594f5c";
const PRIOR_V11_SOURCE_EXPORT_MANIFEST_SHA256: &str =
    "85f8428cd7e60f81d30dce6fd6c6d2df2ae03797db24e15121ff42402f444a87";
const PRIOR_V11_BUILD_STDOUT_SHA256: &str =
    "af28b79f68d789f31d92224f61e821e0a2898fe976a0c0adf42a95c8e17089e6";
const PRIOR_V11_BUILD_STDERR_SHA256: &str =
    "9f5ecf37576ca365ea2ed23981b8092d172cd49dfd6960f6bb5a27eb895dc192";
const PRIOR_V11_ROLLBACK_RESERVE_SHA256: &str =
    "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855";
const PRIOR_V11_ROLLBACK_RESERVE_DEVICE: u64 = 16_777_230;
const PRIOR_V11_ROLLBACK_RESERVE_INODE: u64 = 20_796_192;
const PRIOR_V11_STAGED_EXECUTABLE_SHA256: &str =
    "886a3f5ac94281d06822787fe2057f2477ef4dfdae596d4d1b03332f70075cd3";
const PRIOR_V11_STAGED_PLIST_SHA256: &str =
    "7cdcf2d1517dc9ec1ae49b6fbbaf293c77afd958f697878d44f3b3c8e9c7e550";
const PRIOR_V12_ACTIVE_TRANSACTION_NAME: &str = "active-migration-v12";
const PRIOR_V12_ACTIVE_TRANSACTION_PENDING_NAME: &str = ".active-migration-v12.pending";
const PRIOR_V12_ACTIVE_TRANSACTION_FINALIZING_NAME: &str = ".active-migration-v12.finalizing";
const PRIOR_V12_ACTIVE_TRANSACTION_LINEARIZED_NAME: &str = ".active-migration-v12.linearized";
const PRIOR_V12_EVIDENCE_PATH: &str = "/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v12-after-v11-1785637636-18044";
const PRIOR_V12_ACTIVE_RECORD: &[u8] = b"/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v12-after-v11-1785637636-18044\n";
const PRIOR_V12_ACTIVE_SHA256: &str =
    "8f1294f07108e0e769154da1d24c8254074c624abbd6685548aef7cba114ec75";
const PRIOR_V12_SOURCE_COMMIT: &str = "20977cc6f31ecdf8e1f38b7b887f263b6c631d5f";
const PRIOR_V12_SOURCE_TREE: &str = "25b4b0f6637a32f4bbd6c150c8e7fafbdd07d3be";
const PRIOR_V12_FINAL_JOURNAL_SHA256: &str =
    "e1c601bfa675f555753d0b1ac884b6f547c331b33264087bf52a320aa53d2223";
const PRIOR_V12_FINAL_JOURNAL: &[u8] = br#"OPENSTEAMER_MIGRATION_JOURNAL_V12
STATE BEGUN
STATE BEGUN prior_v9_active_sha256=55c5936e520d65c2096811546357853e05064eca41553603793bea5843518559 prior_v9_journal_sha256=566504aa212b4b4ae627996859991c0aa8742f9fa5019145a9e73ca9c6ddf524 prior_v9_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v9_source_archive_sha256=0d0022af455d2d7a2d49c43025760ece421b9cdd0b33451fad55f338f9746202 prior_v9_source_commit=2ef1c9cbb972c0c138ae36bbe996eacda214113d prior_v10_active_sha256=af917e5ca70f533d1e78b62cf7bda66a682d2fd61dc2d1e337615f52e44ac02a prior_v10_journal_sha256=3d29812b215a1a765492ac76dd849454159170be618334ccfd08585c67371b0c prior_v10_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v10_source_archive_sha256=b742d38f5e21f8febbc6a436112de633cc15e34be9ecd698915b3231a253acb3 prior_v10_source_commit=a0a25f7010a1170330ad7ebd48d0e85839219af4 prior_v10_source_tree=98c0c0d230aa89f56121916f0ef158cf8c0563b1 prior_v10_provenance_sha256=7bea7b1f67a0a88467526b333e6a941302d160c8fe05393a3619ed398821bba6 prior_v10_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v10_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v11_active_sha256=f2c7d26372b9c3fe6c41408a320b7401031847b35406ddc50595972112d6e29c prior_v11_journal_sha256=19cec66b77df4e25dc34a303ca8e1c5ec54c0b30dc39f5dbd0a49d5607e972c5 prior_v11_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v11_source_archive_sha256=81fd74d1de17155109234469fa4da754783a6b1961ea93320d7932e21777748b prior_v11_source_commit=782f845529df161c6cbe61cc8c97b39f7537fc49 prior_v11_source_tree=b643e6fea140ec9ce4b3782a0ff50e39f4de4e8e prior_v11_provenance_sha256=88918466881abe9db8b35956835e390d7de7265f7da1378da445190ab264785d prior_v11_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v11_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730
STATE PROVENANCE_VERIFIED commit=20977cc6f31ecdf8e1f38b7b887f263b6c631d5f tree=25b4b0f6637a32f4bbd6c150c8e7fafbdd07d3be
STATE LEGACY_SNAPSHOTTED
STATE NEW_STAGED
STATE PRECUTOVER_VERIFIED applications_device=16777230 applications_inode=4982341 launch_agents_device=16777230 launch_agents_inode=474668 precutover_available_bytes=1199648768 rollback_reserve_device=16777230 rollback_reserve_inode=20842024 rollback_reserve_bytes=8388608
STATE ROLLBACK_STARTED legacy_disable_was_journaled=false rollback_mode=BeforeLegacyStop
STATE LEGACY_REENABLED
STATE LEGACY_RECOVERED
STATE ROLLED_BACK
"#;
const PRIOR_V12_FINAL_RESULT: &[u8] = b"result=rolled-back-before-stop\nlegacy_launchd_disabled=false\nphysical_iphone_e2e=unavailable-not-claimed\n";
const PRIOR_V12_FINAL_RESULT_SHA256: &str =
    "d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875";
const PRIOR_V12_SOURCE_ARCHIVE_SIZE: u64 = 6_420_480;
const PRIOR_V12_SOURCE_ARCHIVE_SHA256: &str =
    "2f491520d482384905390d810f5879f0860ac19b86090b3395032d339c522ecb";
const PRIOR_V12_PROVENANCE_SHA256: &str =
    "6265e868bcceccd9dc699199f6351d181822ad8c8404b4882ce9d3fe420ad615";
const PRIOR_V12_PROVENANCE: &[u8] = br#"commit=20977cc6f31ecdf8e1f38b7b887f263b6c631d5f
tree=25b4b0f6637a32f4bbd6c150c8e7fafbdd07d3be
remote=https://github.com/ahmedelami/opensteamer.git
upstream=origin/agent/auto-select-iphone-microphone
source_archive_sha256=2f491520d482384905390d810f5879f0860ac19b86090b3395032d339c522ecb
package_resolved_sha256=161213e9507513e41f0acba0d7439fcf633b9d03d78c22b1e4b15fa9f83a01d9
"#;
const PRIOR_V12_LEGACY_MANIFEST_SHA256: &str =
    "2bdaddf99c5101a8f994d3916b44a66f6c8fcbd3c0cda1b3ae44694263d6971f";
const PRIOR_V12_LEGACY_XATTRS_SHA256: &str =
    "cc69a330ffd8dcb92e45bfa1b2f7163f749b2c1875bc2ead51f9ed50dd252ea8";
const PRIOR_V12_STAGED_HASHES_SHA256: &str =
    "aa3cfc53263ca936c3ed7890efca05e93adc054097d3fc31dd4b4d0d26e29c05";
const PRIOR_V12_SOURCE_EXPORT_MANIFEST_SHA256: &str =
    "b21e19a4a1b6801751b128c8d1f40c8359d9e644175c7c48e8e93d060832fdf2";
const PRIOR_V12_BUILD_STDOUT_SHA256: &str =
    "6168803ac7f19fa3bc6454b44781406cfdd4a618430cbef2204bd92fe4ac768d";
const PRIOR_V12_BUILD_STDERR_SHA256: &str =
    "a719cadddacbbf894c719dcb17d2b6de904dc1853143869ec096f99e6c867942";
const PRIOR_V12_ROLLBACK_RESERVE_SHA256: &str =
    "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855";
const PRIOR_V12_ROLLBACK_RESERVE_DEVICE: u64 = 16_777_230;
const PRIOR_V12_ROLLBACK_RESERVE_INODE: u64 = 20_842_024;
const PRIOR_V12_STAGED_EXECUTABLE_SHA256: &str =
    "a1cf1c306a06dc919bbe456850ff1e4652cab596b773cae5df930c556cd42355";
const PRIOR_V12_STAGED_PLIST_SHA256: &str =
    "7cdcf2d1517dc9ec1ae49b6fbbaf293c77afd958f697878d44f3b3c8e9c7e550";
const PRIOR_V12_STAGED_APP_MANIFEST_SHA256: &str =
    "47ae6142c372239ed3fcd4044b44f3368de60e3330a0109c0178b74a5e2a1609";
const PRIOR_V13_ACTIVE_TRANSACTION_NAME: &str = "active-migration-v13";
const PRIOR_V13_ACTIVE_TRANSACTION_PENDING_NAME: &str = ".active-migration-v13.pending";
const PRIOR_V13_ACTIVE_TRANSACTION_FINALIZING_NAME: &str = ".active-migration-v13.finalizing";
const PRIOR_V13_ACTIVE_TRANSACTION_LINEARIZED_NAME: &str = ".active-migration-v13.linearized";
const PRIOR_V13_EVIDENCE_PATH: &str = "/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v13-after-v12-1785637636-18044";
const PRIOR_V13_ACTIVE_RECORD: &[u8] = b"/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v13-after-v12-1785637636-18044\n";
const PRIOR_V13_ACTIVE_SHA256: &str =
    "064ebd22ab6577078a0bd48f47340f2989c297f4ed412a79ca6137a27619b9b6";
const PRIOR_V13_SOURCE_COMMIT: &str = "1073f1eb048d06a99d1681a342b72dd6bf99c078";
const PRIOR_V13_SOURCE_TREE: &str = "44ae00f94b64c72e46f13986294cf0031f0851e9";
const PRIOR_V13_FINAL_JOURNAL_SHA256: &str =
    "9d634fe69335ed2f8f110c4b63bd9c37cfc839d3e827b3d22280c44db4d7039b";
const PRIOR_V13_FINAL_JOURNAL: &[u8] = br#"OPENSTEAMER_MIGRATION_JOURNAL_V13
STATE BEGUN
STATE BEGUN prior_v9_active_sha256=55c5936e520d65c2096811546357853e05064eca41553603793bea5843518559 prior_v9_journal_sha256=566504aa212b4b4ae627996859991c0aa8742f9fa5019145a9e73ca9c6ddf524 prior_v9_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v9_source_archive_sha256=0d0022af455d2d7a2d49c43025760ece421b9cdd0b33451fad55f338f9746202 prior_v9_source_commit=2ef1c9cbb972c0c138ae36bbe996eacda214113d prior_v10_active_sha256=af917e5ca70f533d1e78b62cf7bda66a682d2fd61dc2d1e337615f52e44ac02a prior_v10_journal_sha256=3d29812b215a1a765492ac76dd849454159170be618334ccfd08585c67371b0c prior_v10_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v10_source_archive_sha256=b742d38f5e21f8febbc6a436112de633cc15e34be9ecd698915b3231a253acb3 prior_v10_source_commit=a0a25f7010a1170330ad7ebd48d0e85839219af4 prior_v10_source_tree=98c0c0d230aa89f56121916f0ef158cf8c0563b1 prior_v10_provenance_sha256=7bea7b1f67a0a88467526b333e6a941302d160c8fe05393a3619ed398821bba6 prior_v10_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v10_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v11_active_sha256=f2c7d26372b9c3fe6c41408a320b7401031847b35406ddc50595972112d6e29c prior_v11_journal_sha256=19cec66b77df4e25dc34a303ca8e1c5ec54c0b30dc39f5dbd0a49d5607e972c5 prior_v11_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v11_source_archive_sha256=81fd74d1de17155109234469fa4da754783a6b1961ea93320d7932e21777748b prior_v11_source_commit=782f845529df161c6cbe61cc8c97b39f7537fc49 prior_v11_source_tree=b643e6fea140ec9ce4b3782a0ff50e39f4de4e8e prior_v11_provenance_sha256=88918466881abe9db8b35956835e390d7de7265f7da1378da445190ab264785d prior_v11_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v11_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v12_active_sha256=8f1294f07108e0e769154da1d24c8254074c624abbd6685548aef7cba114ec75 prior_v12_journal_sha256=e1c601bfa675f555753d0b1ac884b6f547c331b33264087bf52a320aa53d2223 prior_v12_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v12_source_archive_sha256=2f491520d482384905390d810f5879f0860ac19b86090b3395032d339c522ecb prior_v12_source_commit=20977cc6f31ecdf8e1f38b7b887f263b6c631d5f prior_v12_source_tree=25b4b0f6637a32f4bbd6c150c8e7fafbdd07d3be prior_v12_provenance_sha256=6265e868bcceccd9dc699199f6351d181822ad8c8404b4882ce9d3fe420ad615 prior_v12_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v12_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730
STATE PROVENANCE_VERIFIED commit=1073f1eb048d06a99d1681a342b72dd6bf99c078 tree=44ae00f94b64c72e46f13986294cf0031f0851e9
STATE LEGACY_SNAPSHOTTED
STATE NEW_STAGED
STATE PRECUTOVER_VERIFIED applications_device=16777230 applications_inode=4982341 launch_agents_device=16777230 launch_agents_inode=474668 precutover_available_bytes=1789804544 rollback_reserve_device=16777230 rollback_reserve_inode=20871866 rollback_reserve_bytes=8388608
STATE LEGACY_DISABLED
STATE LEGACY_STOPPED
STATE LOCK_HANDED_OFF
STATE NEW_INSTALLED
STATE NEW_BOOTSTRAPPED
STATE NEW_PID_OBSERVED log_offset=564 log_device=16777230 log_inode=20570513 pid=80576 runs=1 process_start=Sat%20Aug%20%201%2023%3A53%3A09%202026 nonce=d4bd22a50e7d5e84c3d3d0e649c6f237c8f9e75f6781036b4172351c0e9623b8 lock_device=16777230 lock_inode=10835208
STATE ROLLBACK_STARTED legacy_disable_was_journaled=true rollback_mode=FullRestore
STATE NEW_STOPPED
STATE NEW_DESTINATIONS_CLEARED
STATE LEGACY_REENABLED
...
STATE ROLLED_BACK
"#;
const PRIOR_V13_FINAL_RESULT: &[u8] = b"result=rolled-back\nlegacy_launchd_disabled=false\nphysical_iphone_e2e=unavailable-not-claimed\n";
const PRIOR_V13_FINAL_RESULT_SHA256: &str =
    "434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301";
const PRIOR_V13_SOURCE_ARCHIVE_SIZE: u64 = 6_461_440;
const PRIOR_V13_SOURCE_ARCHIVE_SHA256: &str =
    "42e94758127b3204aa4e75fc86a8917976462140b0d9b914ca201671b3b28d5c";
const PRIOR_V13_PROVENANCE_SHA256: &str =
    "a64891d809a5f44972df2eec7ae8c4412f5c6e64c38785bf5796637f2c7d2c7f";
const PRIOR_V13_PROVENANCE: &[u8] = br#"commit=1073f1eb048d06a99d1681a342b72dd6bf99c078
tree=44ae00f94b64c72e46f13986294cf0031f0851e9
remote=https://github.com/ahmedelami/opensteamer.git
upstream=origin/agent/auto-select-iphone-microphone
source_archive_sha256=42e94758127b3204aa4e75fc86a8917976462140b0d9b914ca201671b3b28d5c
package_resolved_sha256=161213e9507513e41f0acba0d7439fcf633b9d03d78c22b1e4b15fa9f83a01d9
"#;
const PRIOR_V13_LEGACY_MANIFEST_SHA256: &str =
    "2bdaddf99c5101a8f994d3916b44a66f6c8fcbd3c0cda1b3ae44694263d6971f";
const PRIOR_V13_LEGACY_XATTRS_SHA256: &str =
    "cc69a330ffd8dcb92e45bfa1b2f7163f749b2c1875bc2ead51f9ed50dd252ea8";
const PRIOR_V13_STAGED_HASHES_SHA256: &str =
    "ec3bc8c0adf0d7865b2d28080dce64bca975e0b4cbce358442951e850aa08215";
const PRIOR_V13_SOURCE_EXPORT_MANIFEST_SHA256: &str =
    "a49ea7de6879211bf9cb554055bd64b9996b19c458f44a2591dac231c562426c";
const PRIOR_V13_BUILD_STDOUT_SHA256: &str =
    "aedd1ece926c627d997f27243e8d1e983bbe7d57f71c533bf3f5709664a20cfd";
const PRIOR_V13_BUILD_STDERR_SHA256: &str =
    "4591321792a4cd17b43f888c318aafb78a2a8bfd27cf7233db04501002ce54ab";
const PRIOR_V13_DEPLOYMENT_STDOUT_SHA256: &str =
    "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855";
const PRIOR_V13_DEPLOYMENT_STDERR_SHA256: &str =
    "00f46ed0f2887f90df5db6d790381badc5feed4a1d36136067e5da56eb5d2ff8";
const PRIOR_V13_DEPLOYMENT_STDERR: &[u8] =
    b"require_service_absent:8: read-only variable: status\n";
const PRIOR_V13_ROLLBACK_RESERVE_SHA256: &str =
    "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855";
const PRIOR_V13_ROLLBACK_RESERVE_DEVICE: u64 = 16_777_230;
const PRIOR_V13_ROLLBACK_RESERVE_INODE: u64 = 20_871_866;
const PRIOR_V13_STAGED_EXECUTABLE_SHA256: &str =
    "75791affc7e946843cdb8cdb74fe683ce46c01b78517a6a330b3ea29490b3894";
const PRIOR_V13_STAGED_PLIST_SHA256: &str =
    "7cdcf2d1517dc9ec1ae49b6fbbaf293c77afd958f697878d44f3b3c8e9c7e550";
const PRIOR_V13_STAGED_APP_MANIFEST_SHA256: &str =
    "2327e8de3b0d835605fd2a2b6de842c9782d0d8789761328d04e7c227fa3d40d";
const PRIOR_V13_SYMLINK_TARGET_MANIFEST_SHA256: &str =
    "ab17b5de2703ca8b990a315bb816165d6d6bdb898e2b7b6d8c9d59147cbd8fec";
const PRIOR_V13_STAGED_APP_XATTRS_SHA256: &str =
    "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855";
const PRIOR_V13_FAILED_APP_XATTRS_SHA256: &str =
    "7284d20e4e62d3825fc272331f49e29bfa39b8745ca4ab0a49ed2466425bbb1c";
...
const PRIOR_V14_FINAL_JOURNAL: &[u8] = br#"OPENSTEAMER_MIGRATION_JOURNAL_V14
STATE BEGUN
STATE BEGUN prior_v9_active_sha256=55c5936e520d65c2096811546357853e05064eca41553603793bea5843518559 prior_v9_journal_sha256=566504aa212b4b4ae627996859991c0aa8742f9fa5019145a9e73ca9c6ddf524 prior_v9_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v9_source_archive_sha256=0d0022af455d2d7a2d49c43025760ece421b9cdd0b33451fad55f338f9746202 prior_v9_source_commit=2ef1c9cbb972c0c138ae36bbe996eacda214113d prior_v10_active_sha256=af917e5ca70f533d1e78b62cf7bda66a682d2fd61dc2d1e337615f52e44ac02a prior_v10_journal_sha256=3d29812b215a1a765492ac76dd849454159170be618334ccfd08585c67371b0c prior_v10_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v10_source_archive_sha256=b742d38f5e21f8febbc6a436112de633cc15e34be9ecd698915b3231a253acb3 prior_v10_source_commit=a0a25f7010a1170330ad7ebd48d0e85839219af4 prior_v10_source_tree=98c0c0d230aa89f56121916f0ef158cf8c0563b1 prior_v10_provenance_sha256=7bea7b1f67a0a88467526b333e6a941302d160c8fe05393a3619ed398821bba6 prior_v10_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v10_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v11_active_sha256=f2c7d26372b9c3fe6c41408a320b7401031847b35406ddc50595972112d6e29c prior_v11_journal_sha256=19cec66b77df4e25dc34a303ca8e1c5ec54c0b30dc39f5dbd0a49d5607e972c5 prior_v11_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v11_source_archive_sha256=81fd74d1de17155109234469fa4da754783a6b1961ea93320d7932e21777748b prior_v11_source_commit=782f845529df161c6cbe61cc8c97b39f7537fc49 prior_v11_source_tree=b643e6fea140ec9ce4b3782a0ff50e39f4de4e8e prior_v11_provenance_sha256=88918466881abe9db8b35956835e390d7de7265f7da1378da445190ab264785d prior_v11_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v11_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v12_active_sha256=8f1294f07108e0e769154da1d24c8254074c624abbd6685548aef7cba114ec75 prior_v12_journal_sha256=e1c601bfa675f555753d0b1ac884b6f547c331b33264087bf52a320aa53d2223 prior_v12_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v12_source_archive_sha256=2f491520d482384905390d810f5879f0860ac19b86090b3395032d339c522ecb prior_v12_source_commit=20977cc6f31ecdf8e1f38b7b887f263b6c631d5f prior_v12_source_tree=25b4b0f6637a32f4bbd6c150c8e7fafbdd07d3be prior_v12_provenance_sha256=6265e868bcceccd9dc699199f6351d181822ad8c8404b4882ce9d3fe420ad615 prior_v12_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v12_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v13_active_sha256=064ebd22ab6577078a0bd48f47340f2989c297f4ed412a79ca6137a27619b9b6 prior_v13_journal_sha256=9d634fe69335ed2f8f110c4b63bd9c37cfc839d3e827b3d22280c44db4d7039b prior_v13_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v13_source_archive_sha256=42e94758127b3204aa4e75fc86a8917976462140b0d9b914ca201671b3b28d5c prior_v13_source_commit=1073f1eb048d06a99d1681a342b72dd6bf99c078 prior_v13_source_tree=44ae00f94b64c72e46f13986294cf0031f0851e9 prior_v13_provenance_sha256=a64891d809a5f44972df2eec7ae8c4412f5c6e64c38785bf5796637f2c7d2c7f prior_v13_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v13_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730
STATE PROVENANCE_VERIFIED commit=c2d8470f6fac0eac07ff1355e984d57e3f330b74 tree=90b55c6a6f5619f5be9489b52481a719a4732883
STATE LEGACY_SNAPSHOTTED
STATE NEW_STAGED
STATE PRECUTOVER_VERIFIED applications_device=16777230 applications_inode=4982341 launch_agents_device=16777230 launch_agents_inode=474668 precutover_available_bytes=2135261184 rollback_reserve_device=16777230 rollback_reserve_inode=20913894 rollback_reserve_bytes=8388608
STATE LEGACY_DISABLED
STATE LEGACY_STOPPED
STATE LOCK_HANDED_OFF
STATE NEW_INSTALLED
STATE NEW_BOOTSTRAPPED
STATE NEW_PID_OBSERVED log_offset=905 log_device=16777230 log_inode=20570513 pid=67555 runs=1 process_start=Sun%20Aug%20%202%2000%3A44%3A39%202026 nonce=0d8c38d3511db8a1cb1a6fef887b2be2e52edc1ac4fc31147a7b7be572175e52 lock_device=16777230 lock_inode=10835208
STATE ROLLBACK_STARTED legacy_disable_was_journaled=true rollback_mode=FullRestore
STATE NEW_STOPPED
STATE NEW_DESTINATIONS_CLEARED
STATE LEGACY_REENABLED
...
STATE ROLLED_BACK
"#;
const PRIOR_V14_FINAL_RESULT: &[u8] = b"result=rolled-back\nlegacy_launchd_disabled=false\nphysical_iphone_e2e=unavailable-not-claimed\n";
...
const PRIOR_V14_PROVENANCE: &[u8] = br#"commit=c2d8470f6fac0eac07ff1355e984d57e3f330b74
tree=90b55c6a6f5619f5be9489b52481a719a4732883
remote=https://github.com/ahmedelami/opensteamer.git
upstream=origin/agent/auto-select-iphone-microphone
source_archive_sha256=6bdea9203b0dca4034a064e026761a368158646bec6f1667525da8e933bebb49
package_resolved_sha256=161213e9507513e41f0acba0d7439fcf633b9d03d78c22b1e4b15fa9f83a01d9
"#;
...
const PRIOR_V15_FINAL_RESULT: &[u8] = b"result=rolled-back\nlegacy_launchd_disabled=false\nphysical_iphone_e2e=unavailable-not-claimed\n";
...
const PRIOR_V15_PROVENANCE: &[u8] = br#"commit=26869215b5c8c69037652c8feb2db0371ef13648
tree=2ff47b6b082d78108447c0ea0a7bf2e213e06310
remote=https://github.com/ahmedelami/opensteamer.git
upstream=origin/agent/auto-select-iphone-microphone
source_archive_sha256=9794a0894ea873e257fc3c6198ea6321ee1790f5ae5de80a4a698202c3e3883a
package_resolved_sha256=161213e9507513e41f0acba0d7439fcf633b9d03d78c22b1e4b15fa9f83a01d9
"#;
...
const PRIOR_V18_PROVENANCE: &[u8] = br#"commit=ff02ca6ba192b27fd1cd22e807c8d42900084f74
tree=fb56a78b685453901ec0ff8af2fccd446d63ea18
remote=https://github.com/ahmedelami/opensteamer.git
upstream=origin/agent/auto-select-iphone-microphone
source_archive_sha256=ea8ec3d76daa2effb4e6a955240adcc0acd9b5c24b083365218657ebb4a09a13
package_resolved_sha256=161213e9507513e41f0acba0d7439fcf633b9d03d78c22b1e4b15fa9f83a01d9
"#;
...
const PRIOR_V18_FINAL_JOURNAL_FIXTURE: &[u8] = br###"OPENSTEAMER_MIGRATION_JOURNAL_V18
STATE BEGUN
STATE BEGUN prior_v9_active_sha256=55c5936e520d65c2096811546357853e05064eca41553603793bea5843518559 prior_v9_journal_sha256=566504aa212b4b4ae627996859991c0aa8742f9fa5019145a9e73ca9c6ddf524 prior_v9_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v9_source_archive_sha256=0d0022af455d2d7a2d49c43025760ece421b9cdd0b33451fad55f338f9746202 prior_v9_source_commit=2ef1c9cbb972c0c138ae36bbe996eacda214113d prior_v10_active_sha256=af917e5ca70f533d1e78b62cf7bda66a682d2fd61dc2d1e337615f52e44ac02a prior_v10_journal_sha256=3d29812b215a1a765492ac76dd849454159170be618334ccfd08585c67371b0c prior_v10_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v10_source_archive_sha256=b742d38f5e21f8febbc6a436112de633cc15e34be9ecd698915b3231a253acb3 prior_v10_source_commit=a0a25f7010a1170330ad7ebd48d0e85839219af4 prior_v10_source_tree=98c0c0d230aa89f56121916f0ef158cf8c0563b1 prior_v10_provenance_sha256=7bea7b1f67a0a88467526b333e6a941302d160c8fe05393a3619ed398821bba6 prior_v10_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v10_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v11_active_sha256=f2c7d26372b9c3fe6c41408a320b7401031847b35406ddc50595972112d6e29c prior_v11_journal_sha256=19cec66b77df4e25dc34a303ca8e1c5ec54c0b30dc39f5dbd0a49d5607e972c5 prior_v11_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v11_source_archive_sha256=81fd74d1de17155109234469fa4da754783a6b1961ea93320d7932e21777748b prior_v11_source_commit=782f845529df161c6cbe61cc8c97b39f7537fc49 prior_v11_source_tree=b643e6fea140ec9ce4b3782a0ff50e39f4de4e8e prior_v11_provenance_sha256=88918466881abe9db8b35956835e390d7de7265f7da1378da445190ab264785d prior_v11_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v11_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v12_active_sha256=8f1294f07108e0e769154da1d24c8254074c624abbd6685548aef7cba114ec75 prior_v12_journal_sha256=e1c601bfa675f555753d0b1ac884b6f547c331b33264087bf52a320aa53d2223 prior_v12_result_sha256=d1e58fcd7c826e015fab662e5669abfdfa142f904fc3277c5cf62f754890f875 prior_v12_source_archive_sha256=2f491520d482384905390d810f5879f0860ac19b86090b3395032d339c522ecb prior_v12_source_commit=20977cc6f31ecdf8e1f38b7b887f263b6c631d5f prior_v12_source_tree=25b4b0f6637a32f4bbd6c150c8e7fafbdd07d3be prior_v12_provenance_sha256=6265e868bcceccd9dc699199f6351d181822ad8c8404b4882ce9d3fe420ad615 prior_v12_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v12_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v13_active_sha256=064ebd22ab6577078a0bd48f47340f2989c297f4ed412a79ca6137a27619b9b6 prior_v13_journal_sha256=9d634fe69335ed2f8f110c4b63bd9c37cfc839d3e827b3d22280c44db4d7039b prior_v13_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v13_source_archive_sha256=42e94758127b3204aa4e75fc86a8917976462140b0d9b914ca201671b3b28d5c prior_v13_source_commit=1073f1eb048d06a99d1681a342b72dd6bf99c078 prior_v13_source_tree=44ae00f94b64c72e46f13986294cf0031f0851e9 prior_v13_provenance_sha256=a64891d809a5f44972df2eec7ae8c4412f5c6e64c38785bf5796637f2c7d2c7f prior_v13_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v13_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v14_active_sha256=81c54f55aae42bf60e949ae386d028b44eef2823910ce21be855ebbb299e64b6 prior_v14_journal_sha256=8e4554721ae554be868bf9a094ecb5eb34cdec4e7c132f6bfd9235bca677c609 prior_v14_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v14_source_archive_sha256=6bdea9203b0dca4034a064e026761a368158646bec6f1667525da8e933bebb49 prior_v14_source_commit=c2d8470f6fac0eac07ff1355e984d57e3f330b74 prior_v14_source_tree=90b55c6a6f5619f5be9489b52481a719a4732883 prior_v14_provenance_sha256=4f2dd2eaaf60685a045dbd2f14cff2ab73922c5feec755e2660de28fe8cbb317 prior_v14_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v14_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v15_active_sha256=a1aa94936aa8d5f994597525a08569eb487ed2931487f3741e4d5421a3058513 prior_v15_journal_sha256=a812bca76e799ad4b2727b6c6d8c20d84875c787541bea8c1a9a343b5ad07dcc prior_v15_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v15_source_archive_sha256=9794a0894ea873e257fc3c6198ea6321ee1790f5ae5de80a4a698202c3e3883a prior_v15_source_commit=26869215b5c8c69037652c8feb2db0371ef13648 prior_v15_source_tree=2ff47b6b082d78108447c0ea0a7bf2e213e06310 prior_v15_provenance_sha256=d16716934018f9ff0b9d1206d6ed43e4596e0596dd3e226a99fac7df9c208261 prior_v15_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v15_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v16_active_sha256=aaf2d32335687c997d8f623324c1dbb5a00855464ff2f110a2f94eb8bb97c15b prior_v16_journal_sha256=a95a7c0a23f8bc50a0a7270d616e75dac0b72aee2ab4676fa8d3b4be6288fbfb prior_v16_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v16_source_archive_sha256=2e3ade684c280e2263deb520412093d24b85f25a96dc6db14973a3d56388e864 prior_v16_source_commit=625941d4fc1f2f4d6254df57ee897c71c88f399d prior_v16_source_tree=3507c97c3b5be7e11a9ffab6c686d615f5a96506 prior_v16_provenance_sha256=d722f6589eb0834c64b0866bda7034994f83e0266b1cd8d62d8e3541a07aa9ae prior_v16_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v16_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v16_deployment_stderr_sha256=b71cb31d6ff97ce941f65798ee357fcff8c9af922589b1a30d74dbe0071102c0 prior_v17_active_sha256=c67386bd19193e913f7116cc179ec44e1768ef077103f51a897e0774324f765a prior_v17_journal_sha256=9f66fbd1aff49313ce1528d25290dbb032f720fc79c2e04c509ae230704151d1 prior_v17_result_sha256=434dea611969ea91d8b873bffe42e4a149f329641fe5111e898b86d66fc3d301 prior_v17_source_archive_sha256=b1422da32cba1ab7716def3f11f8e2177584a7d8b4f8f893848ea4f6c0651a16 prior_v17_source_commit=bd23d6b7bf9328a383f1d6c8da152754b915eeb5 prior_v17_source_tree=6b536450d997f14b356680c080328cbdced77e67 prior_v17_provenance_sha256=91057613a91cc1d4ae8dc681548e9960fe0de599bbc9acbe110cbe0f12ccb049 prior_v17_legacy_executable_sha256=1bd5bbe685522f995ee01f52650198753d11344857f883898e29ee7a3f4c80bc prior_v17_legacy_plist_sha256=419eff4f410cfb0bf5e224528fd450c10292f7c1c2448d33e215e929f7c14730 prior_v17_deployment_stderr_sha256=11a704463fb667082b2e50bf5877a24d728c0ee7e3b0a48d7686224091262254
STATE PROVENANCE_VERIFIED commit=ff02ca6ba192b27fd1cd22e807c8d42900084f74 tree=fb56a78b685453901ec0ff8af2fccd446d63ea18
STATE LEGACY_SNAPSHOTTED
STATE NEW_STAGED
STATE PRECUTOVER_VERIFIED applications_device=16777230 applications_inode=4982341 launch_agents_device=16777230 launch_agents_inode=474668 precutover_available_bytes=2137174016 rollback_reserve_device=16777230 rollback_reserve_inode=21550474 rollback_reserve_bytes=8388608
STATE LEGACY_DISABLED
STATE LEGACY_STOPPED
STATE LOCK_HANDED_OFF
STATE NEW_INSTALLED
STATE NEW_BOOTSTRAPPED
STATE NEW_PID_OBSERVED log_offset=2127 log_device=16777230 log_inode=20570513 pid=53809 runs=1 process_start=Sun%20Aug%20%202%2016%3A35%3A42%202026 nonce=511ac5970b1235bd964bfffb97cf5dd66d975cdfccbfbd8992eb7d76ec5f7aad lock_device=16777230 lock_inode=10835208
STATE ROLLBACK_STARTED legacy_disable_was_journaled=true rollback_mode=FullRestore
STATE NEW_STOPPED
STATE NEW_DESTINATIONS_CLEARED
STATE LEGACY_REENABLED
...
STATE ROLLED_BACK
"###;
const PRIOR_V18_DEPLOYMENT_STDERR_FIXTURE: &[u8] = br###"/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework: valid on disk
/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework: satisfies its Designated Requirement
--prepared:/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
--validated:/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/MacOS/CaptureServer: valid on disk
/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/MacOS/CaptureServer: satisfies its Designated Requirement
--prepared:/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
--validated:/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app: valid on disk
/Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app: satisfies its Designated Requirement
Verified opensteamer Host bundle: /Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app
/Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework: valid on disk
/Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework: satisfies its Designated Requirement
--prepared:/Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
--validated:/Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
/Applications/opensteamer Host.app/Contents/MacOS/CaptureServer: valid on disk
/Applications/opensteamer Host.app/Contents/MacOS/CaptureServer: satisfies its Designated Requirement
--prepared:/Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
--validated:/Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current/.
/Applications/opensteamer Host.app: valid on disk
/Applications/opensteamer Host.app: satisfies its Designated Requirement
Verified opensteamer Host bundle: /Applications/opensteamer Host.app
diff: /Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/A/Headers: Directory loop detected
diff: /Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/A/Headers: Directory loop detected
diff: /Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/A/Modules: Directory loop detected
diff: /Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/A/Modules: Directory loop detected
diff: /Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/A/Resources: Directory loop detected
diff: /Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/A/Resources: Directory loop detected
diff: /Users/ahmed/Library/Application Support/opensteamer/migrations/migration-v18-after-v17-1785637636-18044/staged/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current: Directory loop detected
diff: /Applications/opensteamer Host.app/Contents/Frameworks/LiveKitWebRTC.framework/Versions/Current: Directory loop detected
53809: dynamically valid
53809: valid on disk
53809: satisfies its Designated Requirement
53809: dynamically valid
53809: valid on disk
53809: satisfies its Designated Requirement
53809: explicit requirement satisfied
opensteamer host deployment verification failed: process start identity differs from the controller-observed generation
"###;
...
fn drain_nonblocking<R: Read>(reader: &mut R, output: &mut Vec<u8>, label: &str) -> Result<bool> {
    let mut buffer = [0u8; 8192];
    let mut drained = 0usize;
    loop {
        let remaining = MAX_DRAIN_BYTES_PER_POLL.saturating_sub(drained);
        if remaining == 0 {
            return Ok(false);
        }
...
fn canonical_command_timeout_error(
    program: &Path,
    reap_result: Option<&Result<ExitStatus>>,
    stdout_bytes: &[u8],
    stderr_bytes: &[u8],
    stdout_drain_error: Option<&str>,
    stderr_drain_error: Option<&str>,
) -> ControllerError {
    let termination = match reap_result {
        None => "not-started".to_owned(),
        Some(Ok(status)) => format!("process-group-terminated,reaped={:?}", status.code()),
        Some(Err(error)) => format!("process-group-termination-attempted,reap_error={}", error),
    };
    ControllerError(format!(
        "command '{}' exceeded its monotonic deadline budget ({termination}, stdout_bytes={}, stderr={}, post-timeout-stdout-drain={:?}, post-timeout-stderr-drain={:?})",
        program.display(),
        stdout_bytes.len(),
...
fn run_spawned_command(
    ...
    loop {
        if let Err(error) = drain_nonblocking(&mut stdout, &mut stdout_bytes, "child stdout")
            .and_then(|_| drain_nonblocking(&mut stderr, &mut stderr_bytes, "child stderr"))
        {
            let _ = terminate_process_group_and_reap(&mut child, program, deadline);
            return Err(error);
        }
        if let Some(status) = child.try_wait().map_err(|error| {
            ...
            let _ = drain_nonblocking(&mut stdout, &mut stdout_bytes, "child stdout")?;
            let _ = drain_nonblocking(&mut stderr, &mut stderr_bytes, "child stderr")?;
        ...
        let now = Instant::now();
        if now >= kill_at {
            let reap_result = terminate_process_group_and_reap(&mut child, program, deadline);
            let stdout_drain_error =
                drain_nonblocking(&mut stdout, &mut stdout_bytes, "timed-out child stdout")
                    .err()
                    .map(|error| error.to_string());
            let stderr_drain_error =
                drain_nonblocking(&mut stderr, &mut stderr_bytes, "timed-out child stderr")
                    .err()
                    .map(|error| error.to_string());
            return Err(canonical_command_timeout_error(
                program,
                ...
                &stdout_bytes,
                &stderr_bytes,
                stdout_drain_error.as_deref(),
                stderr_drain_error.as_deref(),
            ));
        }
        thread::sleep(
            kill_at
...
fn run_command_with_stdout_file(
    ...
    let kill_at = command_kill_at(started, deadline);
    loop {
        if let Err(error) = drain_nonblocking(&mut stderr, &mut stderr_bytes, "child stderr") {
            let _ = terminate_process_group_and_reap(&mut child, program, deadline);
            return Err(error);
        }
        if let Some(status) = child.try_wait().map_err(|error| {
...
fn controller_main() -> Result<()> {
    ...
    match arguments.as_slice() {
        ...
        [_, mode] if mode == PRIOR_RETRY_PREFLIGHT_MODE => verify_prior_retry_state_cli(),
        [_, mode, root] if mode == AUTHORIZED_MODE => execute(Path::new(root)),
        _ => Err(ControllerError(format!(
            "usage: {} {AUTHORIZED_MODE} <absolute-canonical-repository-root>\n       {} {PRIOR_RETRY_PREFLIGHT_MODE}\n       {} {SELF_TEST_MODE} <all|crash|faults|rollback|readiness|concurrency|journal|publication|disable|committed|active-pointer|side-effects|parsers|zsh-verifiers|generation-race|deadlines|modes|real-adapter>\n       {} --probe-lock <runtime-directory> <lock-file> <expected-pid>",
...
fn verify_prior_retry_state_cli() -> Result<()> {
    if cfg!(not(target_os = "macos")) {
        return Err(ControllerError(
            "the reviewed prior-retry preflight may run only on macOS".to_owned(),
        ));
    }
    if effective_uid() != USER_ID {
        return Err(ControllerError(format!(
            "prior-retry preflight must run as audited uid {USER_ID}, found {}",
            effective_uid()
        )));
    }
    ...
    let prior_v12 = validate_prior_v12_rolledback_retry(private_root)?;
    ...
    prior_v12.revalidate(private_root)?;
...
fn require_prior_retry_residues_absent(
    ...
    for residue in [pending_name, finalizing_name, linearized_name] {
        if private_root
            .open_existing_regular(residue, false)?
            .is_some()
        {
            return Err(ControllerError(format!(
                "prior {version} active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    ...
    let tag = evidence
        .file_name()
        .and_then(OsStr::to_str)
        .ok_or_else(|| ControllerError(format!("prior {version} evidence tag is not UTF-8")))?;
    for residue in [
        Path::new(APPLICATIONS_DIRECTORY).join(format!(".opensteamer-disabled-{version}-{tag}")),
        ...
        Path::new("/Users/ahmed/Library/LaunchAgents").join(format!(
            ".org.example.opensteamer.worldwide.plist.disabled-{version}-{tag}"
        )),
        Path::new("/Users/ahmed/Library/LaunchAgents").join(format!(
        ...
        if entry_exists(&residue)? {
            return Err(ControllerError(format!(
                "prior {version} rollback residue remains at {}",
                residue.display()
            )));
        }
    }
...
fn require_all_prior_retry_residues_absent(private_root: &PinnedDirectory) -> Result<()> {
    ...
    require_prior_retry_residues_absent(
        private_root,
        PRIOR_V11_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V11_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V11_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        "v11",
        Path::new(PRIOR_V11_EVIDENCE_PATH),
    )?;
    require_prior_retry_residues_absent(
        private_root,
        PRIOR_V12_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V12_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V12_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        "v12",
        Path::new(PRIOR_V12_EVIDENCE_PATH),
    )?;
    require_prior_retry_residues_absent(
        private_root,
        PRIOR_V13_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V13_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V13_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        "v13",
        Path::new(PRIOR_V13_EVIDENCE_PATH),
    )?;
    require_prior_retry_residues_absent(
        private_root,
        ...
        "v14",
        Path::new(PRIOR_V14_EVIDENCE_PATH),
    )?;
    require_prior_retry_residues_absent(
        private_root,
    ...
    require_prior_retry_residues_absent(
        ...
        "v17",
        Path::new(PRIOR_V17_EVIDENCE_PATH),
    )?;
    require_prior_retry_residues_absent(
        private_root,
...
fn validate_prior_v11_rolledback_records(
    evidence: &Path,
    journal: &[u8],
    result: &[u8],
    provenance: &[u8],
) -> Result<()> {
    if evidence != Path::new(PRIOR_V11_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v11 pointer does not name the exact reviewed evidence".to_owned(),
        ));
    }
    if journal != PRIOR_V11_FINAL_JOURNAL {
        return Err(ControllerError(
            "prior v11 journal is not the exact reviewed post-readiness-timeout rollback"
                .to_owned(),
        ));
    }
    if result != PRIOR_V11_FINAL_RESULT {
        return Err(ControllerError(
            "prior v11 result is not the exact reviewed rolled-back outcome".to_owned(),
        ));
    }
    if provenance != PRIOR_V11_PROVENANCE {
        return Err(ControllerError(
            "prior v11 provenance is not the exact reviewed record".to_owned(),
        ));
    }
    Ok(())
}

struct PriorV11RetryGuard {
    pointer: File,
    evidence: PinnedDirectory,
    records: PinnedDirectory,
    legacy_snapshot: PinnedDirectory,
...
impl PriorV11RetryGuard {
    fn journal_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            (
                "prior_v11_active_sha256",
                PRIOR_V11_ACTIVE_SHA256.to_owned(),
            ),
            (
                "prior_v11_journal_sha256",
                PRIOR_V11_FINAL_JOURNAL_SHA256.to_owned(),
            ),
            (
                "prior_v11_result_sha256",
                PRIOR_V11_FINAL_RESULT_SHA256.to_owned(),
            ),
            (
                "prior_v11_source_archive_sha256",
                PRIOR_V11_SOURCE_ARCHIVE_SHA256.to_owned(),
            ),
            (
                "prior_v11_source_commit",
                PRIOR_V11_SOURCE_COMMIT.to_owned(),
            ),
            ("prior_v11_source_tree", PRIOR_V11_SOURCE_TREE.to_owned()),
            (
                "prior_v11_provenance_sha256",
                PRIOR_V11_PROVENANCE_SHA256.to_owned(),
            ),
            (
                "prior_v11_legacy_executable_sha256",
                LEGACY_EXECUTABLE_SHA256.to_owned(),
            ),
            (
                "prior_v11_legacy_plist_sha256",
                LEGACY_PLIST_SHA256.to_owned(),
            ),
        ]
    }
    ...
    fn revalidate(&self, private_root: &PinnedDirectory) -> Result<()> {
        ...
        private_root.ensure_file_at_name(PRIOR_V11_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        let pointer_path = private_root.path.join(PRIOR_V11_ACTIVE_TRANSACTION_NAME);
        let pointer = read_opened_regular(&self.pointer, &pointer_path, 0o600)?;
        if pointer != PRIOR_V11_ACTIVE_RECORD || sha256_bytes(&pointer)? != PRIOR_V11_ACTIVE_SHA256
        {
            return Err(ControllerError(
                "prior v11 active pointer changed during retry proof".to_owned(),
            ));
        }
        private_root.ensure_file_at_name(PRIOR_V11_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        ...
        validate_prior_v11_rolledback_records(&self.evidence.path, &journal, &result, &provenance)?;
        if tree_manifest(&self.source_export.path)?.as_bytes() != source_export_manifest {
            return Err(ControllerError(
                "prior v11 source export differs from its exact reviewed manifest".to_owned(),
            ));
        }
        if tree_manifest(Path::new(LEGACY_APP))?.as_bytes() != legacy_manifest {
            return Err(ControllerError(
                "live legacy app differs from the exact prior v11 snapshot manifest".to_owned(),
            ));
        }
        if capture_legacy_xattrs()?.as_bytes() != legacy_xattrs {
            return Err(ControllerError(
                "live legacy app xattrs differ from the exact prior v11 snapshot".to_owned(),
            ));
        }
        if sha256_bytes(&journal)? != PRIOR_V11_FINAL_JOURNAL_SHA256
            || sha256_bytes(&result)? != PRIOR_V11_FINAL_RESULT_SHA256
            || sha256_bytes(&provenance)? != PRIOR_V11_PROVENANCE_SHA256
        {
            return Err(ControllerError(
                "prior v11 journal, result, or provenance hash changed during retry proof"
                    .to_owned(),
            ));
        }
        for (path, bytes, expected) in [
            (
                self.records.path.join("legacy-app-tree-manifest.txt"),
                legacy_manifest.as_slice(),
                PRIOR_V11_LEGACY_MANIFEST_SHA256,
            ),
            (
                self.records.path.join("legacy-app-xattrs.txt"),
                legacy_xattrs.as_slice(),
                PRIOR_V11_LEGACY_XATTRS_SHA256,
            ),
            (
                self.records.path.join("staged-hashes.txt"),
                staged_hashes.as_slice(),
                PRIOR_V11_STAGED_HASHES_SHA256,
            ),
            (
                self.records.path.join("source-export-manifest.txt"),
                source_export_manifest.as_slice(),
                PRIOR_V11_SOURCE_EXPORT_MANIFEST_SHA256,
            ),
            (
                self.records.path.join("build.stdout"),
                build_stdout.as_slice(),
                PRIOR_V11_BUILD_STDOUT_SHA256,
            ),
            (
                self.records.path.join("build.stderr"),
                build_stderr.as_slice(),
                PRIOR_V11_BUILD_STDERR_SHA256,
            ),
            (
                self.records.path.join("rollback-reserve.bin"),
                rollback_reserve.as_slice(),
                PRIOR_V11_ROLLBACK_RESERVE_SHA256,
            ),
        ] {
            if sha256_bytes(bytes)? != expected {
                return Err(ControllerError(format!(
                    "prior v11 anchored record changed: {}",
                    path.display()
                )));
            }
        }
        if !rollback_reserve.is_empty() {
            return Err(ControllerError(
                "prior v11 rollback reserve was not durably released".to_owned(),
            ));
        }
        let rollback_reserve_metadata = self.rollback_reserve.metadata()?;
        if rollback_reserve_metadata.dev() != PRIOR_V11_ROLLBACK_RESERVE_DEVICE
            || rollback_reserve_metadata.ino() != PRIOR_V11_ROLLBACK_RESERVE_INODE
        {
            return Err(ControllerError(
                "prior v11 rollback reserve inode changed".to_owned(),
            ));
        }
        ...
        if archive_metadata.len() != PRIOR_V11_SOURCE_ARCHIVE_SIZE
            || sha256_bytes(&source_archive)? != PRIOR_V11_SOURCE_ARCHIVE_SHA256
        {
            return Err(ControllerError(
                "prior v11 source archive differs from the reviewed rolled-back attempt".to_owned(),
            ));
        }
        let snapshot_executable = read_opened_regular(
            &self.snapshot_executable,
        ...
        {
            return Err(ControllerError(
                "prior v11 offline legacy snapshot changed".to_owned(),
            ));
        }
        ...
        if sha256_file(&self.staged_app.path.join("Contents/MacOS/CaptureServer"))?
            != PRIOR_V11_STAGED_EXECUTABLE_SHA256
            || sha256_file(&self.failed_app.path.join("Contents/MacOS/CaptureServer"))?
                != PRIOR_V11_STAGED_EXECUTABLE_SHA256
            || sha256_bytes(&staged_plist)? != PRIOR_V11_STAGED_PLIST_SHA256
            || sha256_bytes(&failed_plist)? != PRIOR_V11_STAGED_PLIST_SHA256
        {
            return Err(ControllerError(
                "prior v11 staged or archived artifact hash changed".to_owned(),
            ));
        }
        if staged_plist != failed_plist
            || directory_manifest(&self.failed_app.path)?
                != directory_manifest(&self.staged_app.path)?
        {
            return Err(ControllerError(
                "prior v11 archived destinations differ from their staged artifacts".to_owned(),
            ));
        }
...
fn validate_prior_v11_rolledback_retry(
    private_root: &PinnedDirectory,
) -> Result<PriorV11RetryGuard> {
    for residue in [
        PRIOR_V11_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V11_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V11_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        ...
        {
            return Err(ControllerError(format!(
                "prior v11 active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    let pointer =
        open_required_pinned_regular(private_root, PRIOR_V11_ACTIVE_TRANSACTION_NAME, 0o600)?;
    let pointer_bytes = read_opened_regular(
        &pointer,
        &private_root.path.join(PRIOR_V11_ACTIVE_TRANSACTION_NAME),
        0o600,
    )?;
    if pointer_bytes != PRIOR_V11_ACTIVE_RECORD {
        return Err(ControllerError(
            "prior v11 active pointer is not the exact reviewed record".to_owned(),
        ));
    }
    let evidence_path = parse_active_record(&pointer_bytes)?;
    if evidence_path != Path::new(PRIOR_V11_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v11 active pointer resolved to unexpected evidence".to_owned(),
        ));
    }
    ...
    let records = evidence
        .try_open_directory_child("records", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v11 evidence lacks records".to_owned()))?;
    let legacy_snapshot = evidence
        .try_open_directory_child("legacy-snapshot", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v11 evidence lacks legacy snapshot".to_owned()))?;
    let failed_new = evidence
        .try_open_directory_child("failed-new", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v11 evidence lacks failed-new".to_owned()))?;
    let failed_app = failed_new
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v11 evidence lacks archived app".to_owned()))?;
    let staged = evidence
        .try_open_directory_child("staged", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v11 evidence lacks staged directory".to_owned()))?;
    let staged_app = staged
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v11 evidence lacks staged app".to_owned()))?;
    let source_export = evidence
        .try_open_directory_child("source-export", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v11 evidence lacks source export directory".to_owned())
        })?;
    let scratch = evidence
        .try_open_directory_child("swiftpm-scratch", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v11 evidence lacks SwiftPM scratch directory".to_owned())
        })?;
    let journal = open_required_pinned_regular(&evidence, "journal.log", 0o600)?;
    let result = open_required_pinned_regular(&records, "result.txt", 0o600)?;
    let provenance = open_required_pinned_regular(&records, "provenance.txt", 0o600)?;
    ...
    let tag = guard
        ...
        .file_name()
        .and_then(OsStr::to_str)
        .ok_or_else(|| ControllerError("prior v11 evidence tag is not UTF-8".to_owned()))?;
    for residue in [
        ...
        if entry_exists(&residue)? {
            return Err(ControllerError(format!(
                "prior v11 rollback residue remains at {}",
                residue.display()
            )));
        }
    }
...
fn validate_prior_v12_rolledback_records(
    evidence: &Path,
    journal: &[u8],
    result: &[u8],
    provenance: &[u8],
) -> Result<()> {
    if evidence != Path::new(PRIOR_V12_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v12 pointer does not name the exact reviewed evidence".to_owned(),
        ));
    }
    if journal != PRIOR_V12_FINAL_JOURNAL {
        return Err(ControllerError(
            "prior v12 journal is not the exact reviewed pre-stop rollback".to_owned(),
        ));
    }
    if result != PRIOR_V12_FINAL_RESULT {
        return Err(ControllerError(
            "prior v12 result is not the exact reviewed rolled-back outcome".to_owned(),
        ));
    }
    if provenance != PRIOR_V12_PROVENANCE {
        return Err(ControllerError(
            "prior v12 provenance is not the exact reviewed record".to_owned(),
        ));
    }
    Ok(())
}

struct PriorV12RetryGuard {
    pointer: File,
    evidence: PinnedDirectory,
    records: PinnedDirectory,
    legacy_snapshot: PinnedDirectory,
...
impl PriorV12RetryGuard {
    fn journal_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            (
                "prior_v12_active_sha256",
                PRIOR_V12_ACTIVE_SHA256.to_owned(),
            ),
            (
                "prior_v12_journal_sha256",
                PRIOR_V12_FINAL_JOURNAL_SHA256.to_owned(),
            ),
            (
                "prior_v12_result_sha256",
                PRIOR_V12_FINAL_RESULT_SHA256.to_owned(),
            ),
            (
                "prior_v12_source_archive_sha256",
                PRIOR_V12_SOURCE_ARCHIVE_SHA256.to_owned(),
            ),
            (
                "prior_v12_source_commit",
                PRIOR_V12_SOURCE_COMMIT.to_owned(),
            ),
            ("prior_v12_source_tree", PRIOR_V12_SOURCE_TREE.to_owned()),
            (
                "prior_v12_provenance_sha256",
                PRIOR_V12_PROVENANCE_SHA256.to_owned(),
            ),
            (
                "prior_v12_legacy_executable_sha256",
                LEGACY_EXECUTABLE_SHA256.to_owned(),
            ),
            (
                "prior_v12_legacy_plist_sha256",
    ...
    fn revalidate(&self, private_root: &PinnedDirectory) -> Result<()> {
        ...
        private_root.ensure_file_at_name(PRIOR_V12_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        let pointer_path = private_root.path.join(PRIOR_V12_ACTIVE_TRANSACTION_NAME);
        let pointer = read_opened_regular(&self.pointer, &pointer_path, 0o600)?;
        if pointer != PRIOR_V12_ACTIVE_RECORD || sha256_bytes(&pointer)? != PRIOR_V12_ACTIVE_SHA256
        {
            return Err(ControllerError(
                "prior v12 active pointer changed during retry proof".to_owned(),
            ));
        }
        private_root.ensure_file_at_name(PRIOR_V12_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        ...
        require_exact_directory_entries(&self.failed_new, &[])?;
        require_exact_directory_entries(
            &self.staged,
            &[
                "opensteamer Host.app",
        ...
        validate_prior_v12_rolledback_records(&self.evidence.path, &journal, &result, &provenance)?;
        if tree_manifest(&self.source_export.path)?.as_bytes() != source_export_manifest {
            return Err(ControllerError(
                "prior v12 source export differs from its exact reviewed manifest".to_owned(),
            ));
        }
        if tree_manifest(Path::new(LEGACY_APP))?.as_bytes() != legacy_manifest {
            return Err(ControllerError(
                "live legacy app differs from the exact prior v12 snapshot manifest".to_owned(),
            ));
        }
        if capture_legacy_xattrs()?.as_bytes() != legacy_xattrs {
            return Err(ControllerError(
                "live legacy app xattrs differ from the exact prior v12 snapshot".to_owned(),
            ));
        }
        if sha256_bytes(&journal)? != PRIOR_V12_FINAL_JOURNAL_SHA256
            || sha256_bytes(&result)? != PRIOR_V12_FINAL_RESULT_SHA256
            || sha256_bytes(&provenance)? != PRIOR_V12_PROVENANCE_SHA256
        {
            return Err(ControllerError(
                "prior v12 journal, result, or provenance hash changed during retry proof"
                    .to_owned(),
            ));
        }
        for (path, bytes, expected) in [
            (
                self.records.path.join("legacy-app-tree-manifest.txt"),
                legacy_manifest.as_slice(),
                PRIOR_V12_LEGACY_MANIFEST_SHA256,
            ),
            (
                self.records.path.join("legacy-app-xattrs.txt"),
                legacy_xattrs.as_slice(),
                PRIOR_V12_LEGACY_XATTRS_SHA256,
            ),
            (
                self.records.path.join("staged-hashes.txt"),
                staged_hashes.as_slice(),
                PRIOR_V12_STAGED_HASHES_SHA256,
            ),
            (
                self.records.path.join("source-export-manifest.txt"),
                source_export_manifest.as_slice(),
                PRIOR_V12_SOURCE_EXPORT_MANIFEST_SHA256,
            ),
            (
                self.records.path.join("build.stdout"),
                build_stdout.as_slice(),
                PRIOR_V12_BUILD_STDOUT_SHA256,
            ),
            (
                self.records.path.join("build.stderr"),
                build_stderr.as_slice(),
                PRIOR_V12_BUILD_STDERR_SHA256,
            ),
            (
                self.records.path.join("rollback-reserve.bin"),
                rollback_reserve.as_slice(),
                PRIOR_V12_ROLLBACK_RESERVE_SHA256,
            ),
        ] {
            if sha256_bytes(bytes)? != expected {
                return Err(ControllerError(format!(
                    "prior v12 anchored record changed: {}",
                    path.display()
                )));
            }
        }
        if !rollback_reserve.is_empty() {
            return Err(ControllerError(
                "prior v12 rollback reserve was not durably released".to_owned(),
            ));
        }
        let rollback_reserve_metadata = self.rollback_reserve.metadata()?;
        if rollback_reserve_metadata.dev() != PRIOR_V12_ROLLBACK_RESERVE_DEVICE
            || rollback_reserve_metadata.ino() != PRIOR_V12_ROLLBACK_RESERVE_INODE
        {
            return Err(ControllerError(
                "prior v12 rollback reserve inode changed".to_owned(),
            ));
        }
        ...
        if archive_metadata.len() != PRIOR_V12_SOURCE_ARCHIVE_SIZE
            || sha256_bytes(&source_archive)? != PRIOR_V12_SOURCE_ARCHIVE_SHA256
        {
            return Err(ControllerError(
                "prior v12 source archive differs from the reviewed rolled-back attempt".to_owned(),
            ));
        }
        let snapshot_executable = read_opened_regular(
            &self.snapshot_executable,
        ...
        {
            return Err(ControllerError(
                "prior v12 offline legacy snapshot changed".to_owned(),
            ));
        }
        let staged_plist = read_opened_regular(
            &self.staged_plist,
        ...
        if sha256_file(&self.staged_app.path.join("Contents/MacOS/CaptureServer"))?
            != PRIOR_V12_STAGED_EXECUTABLE_SHA256
            || sha256_bytes(&staged_plist)? != PRIOR_V12_STAGED_PLIST_SHA256
        {
            return Err(ControllerError(
                "prior v12 staged artifact hash changed".to_owned(),
            ));
        }
        let staged_app_manifest = directory_manifest(&self.staged_app.path)?;
        if sha256_bytes(staged_app_manifest.as_bytes())? != PRIOR_V12_STAGED_APP_MANIFEST_SHA256 {
            return Err(ControllerError(
                "prior v12 full staged app manifest changed".to_owned(),
            ));
        }
...
fn validate_prior_v12_rolledback_retry(
    private_root: &PinnedDirectory,
) -> Result<PriorV12RetryGuard> {
    for residue in [
        PRIOR_V12_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V12_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V12_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        ...
        {
            return Err(ControllerError(format!(
                "prior v12 active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    let pointer =
        open_required_pinned_regular(private_root, PRIOR_V12_ACTIVE_TRANSACTION_NAME, 0o600)?;
    let pointer_bytes = read_opened_regular(
        &pointer,
        &private_root.path.join(PRIOR_V12_ACTIVE_TRANSACTION_NAME),
        0o600,
    )?;
    if pointer_bytes != PRIOR_V12_ACTIVE_RECORD {
        return Err(ControllerError(
            "prior v12 active pointer is not the exact reviewed record".to_owned(),
        ));
    }
    let evidence_path = parse_active_record(&pointer_bytes)?;
    if evidence_path != Path::new(PRIOR_V12_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v12 active pointer resolved to unexpected evidence".to_owned(),
        ));
    }
    ...
    let records = evidence
        .try_open_directory_child("records", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v12 evidence lacks records".to_owned()))?;
    let legacy_snapshot = evidence
        .try_open_directory_child("legacy-snapshot", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v12 evidence lacks legacy snapshot".to_owned()))?;
    let failed_new = evidence
        .try_open_directory_child("failed-new", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v12 evidence lacks failed-new".to_owned()))?;
    let staged = evidence
        .try_open_directory_child("staged", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v12 evidence lacks staged directory".to_owned()))?;
    let staged_app = staged
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v12 evidence lacks staged app".to_owned()))?;
    let source_export = evidence
        .try_open_directory_child("source-export", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v12 evidence lacks source export directory".to_owned())
        })?;
    let scratch = evidence
        .try_open_directory_child("swiftpm-scratch", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v12 evidence lacks SwiftPM scratch directory".to_owned())
        })?;
    let journal = open_required_pinned_regular(&evidence, "journal.log", 0o600)?;
    let result = open_required_pinned_regular(&records, "result.txt", 0o600)?;
    let provenance = open_required_pinned_regular(&records, "provenance.txt", 0o600)?;
    ...
    let tag = guard
        ...
        .file_name()
        .and_then(OsStr::to_str)
        .ok_or_else(|| ControllerError("prior v12 evidence tag is not UTF-8".to_owned()))?;
    for residue in [
        Path::new(APPLICATIONS_DIRECTORY).join(format!(".opensteamer-disabled-v12-{tag}")),
        Path::new(APPLICATIONS_DIRECTORY).join(format!(".opensteamer-install-hold-{tag}")),
        Path::new("/Users/ahmed/Library/LaunchAgents").join(format!(
            ".org.example.opensteamer.worldwide.plist.disabled-v12-{tag}"
        )),
        Path::new("/Users/ahmed/Library/LaunchAgents").join(format!(
            ".org.example.opensteamer.worldwide.plist.install-{tag}"
        )),
        ...
        if entry_exists(&residue)? {
            return Err(ControllerError(format!(
                "prior v12 rollback residue remains at {}",
                residue.display()
            )));
        }
    }
...
fn validate_prior_v13_rolledback_records(
    evidence: &Path,
    journal: &[u8],
    result: &[u8],
    provenance: &[u8],
) -> Result<()> {
    if evidence != Path::new(PRIOR_V13_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v13 pointer does not name the exact reviewed evidence".to_owned(),
        ));
    }
    if journal != PRIOR_V13_FINAL_JOURNAL {
        return Err(ControllerError(
            "prior v13 journal is not the exact reviewed deployment-verifier rollback".to_owned(),
        ));
    }
    if result != PRIOR_V13_FINAL_RESULT {
        return Err(ControllerError(
            "prior v13 result is not the exact reviewed rolled-back outcome".to_owned(),
        ));
    }
    if provenance != PRIOR_V13_PROVENANCE {
        return Err(ControllerError(
            "prior v13 provenance is not the exact reviewed record".to_owned(),
        ));
    }
    Ok(())
}

struct PriorV13RetryGuard {
    pointer: File,
    evidence: PinnedDirectory,
    records: PinnedDirectory,
    legacy_snapshot: PinnedDirectory,
...
impl PriorV13RetryGuard {
    fn journal_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            (
                "prior_v13_active_sha256",
                PRIOR_V13_ACTIVE_SHA256.to_owned(),
            ),
            (
                "prior_v13_journal_sha256",
                PRIOR_V13_FINAL_JOURNAL_SHA256.to_owned(),
            ),
            (
                "prior_v13_result_sha256",
                PRIOR_V13_FINAL_RESULT_SHA256.to_owned(),
            ),
            (
                "prior_v13_source_archive_sha256",
                PRIOR_V13_SOURCE_ARCHIVE_SHA256.to_owned(),
            ),
            (
                "prior_v13_source_commit",
                PRIOR_V13_SOURCE_COMMIT.to_owned(),
            ),
            ("prior_v13_source_tree", PRIOR_V13_SOURCE_TREE.to_owned()),
            (
                "prior_v13_provenance_sha256",
                PRIOR_V13_PROVENANCE_SHA256.to_owned(),
            ),
            (
                "prior_v13_legacy_executable_sha256",
                LEGACY_EXECUTABLE_SHA256.to_owned(),
    ...
    fn revalidate(&self, private_root: &PinnedDirectory) -> Result<()> {
        ...
        private_root.ensure_file_at_name(PRIOR_V13_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        let pointer_path = private_root.path.join(PRIOR_V13_ACTIVE_TRANSACTION_NAME);
        let pointer = read_opened_regular(&self.pointer, &pointer_path, 0o600)?;
        if pointer != PRIOR_V13_ACTIVE_RECORD || sha256_bytes(&pointer)? != PRIOR_V13_ACTIVE_SHA256
        {
            return Err(ControllerError(
                "prior v13 active pointer changed during retry proof".to_owned(),
            ));
        }
        private_root.ensure_file_at_name(PRIOR_V13_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        ...
        self.records
            .ensure_file_at_name("build.stderr", &self.build_stderr)?;
        self.records
            .ensure_file_at_name("deployment.stdout", &self.deployment_stdout)?;
        self.records
            .ensure_file_at_name("deployment.stderr", &self.deployment_stderr)?;
        self.records
            .ensure_file_at_name("rollback-reserve.bin", &self.rollback_reserve)?;
        self.staged.ensure_file_at_name(
            "org.example.opensteamer.worldwide.plist",
        ...
        validate_prior_v13_rolledback_records(&self.evidence.path, &journal, &result, &provenance)?;
        if tree_manifest(&self.source_export.path)?.as_bytes() != source_export_manifest {
            return Err(ControllerError(
                "prior v13 source export differs from its exact reviewed manifest".to_owned(),
            ));
        }
        if tree_manifest(Path::new(LEGACY_APP))?.as_bytes() != legacy_manifest {
            return Err(ControllerError(
                "live legacy app differs from the exact prior v13 snapshot manifest".to_owned(),
            ));
        }
        if capture_legacy_xattrs()?.as_bytes() != legacy_xattrs {
            return Err(ControllerError(
                "live legacy app xattrs differ from the exact prior v13 snapshot".to_owned(),
            ));
        }
        if sha256_bytes(&journal)? != PRIOR_V13_FINAL_JOURNAL_SHA256
            || sha256_bytes(&result)? != PRIOR_V13_FINAL_RESULT_SHA256
            || sha256_bytes(&provenance)? != PRIOR_V13_PROVENANCE_SHA256
        {
            return Err(ControllerError(
                "prior v13 journal, result, or provenance hash changed during retry proof"
                    .to_owned(),
            ));
        }
        for (path, bytes, expected) in [
            (
                self.records.path.join("legacy-app-tree-manifest.txt"),
                legacy_manifest.as_slice(),
                PRIOR_V13_LEGACY_MANIFEST_SHA256,
            ),
            (
                self.records.path.join("legacy-app-xattrs.txt"),
                legacy_xattrs.as_slice(),
                PRIOR_V13_LEGACY_XATTRS_SHA256,
            ),
            (
                self.records.path.join("staged-hashes.txt"),
                staged_hashes.as_slice(),
                PRIOR_V13_STAGED_HASHES_SHA256,
            ),
            (
                self.records.path.join("source-export-manifest.txt"),
                source_export_manifest.as_slice(),
                PRIOR_V13_SOURCE_EXPORT_MANIFEST_SHA256,
            ),
            (
                self.records.path.join("build.stdout"),
                build_stdout.as_slice(),
                PRIOR_V13_BUILD_STDOUT_SHA256,
            ),
            (
                self.records.path.join("build.stderr"),
                build_stderr.as_slice(),
                PRIOR_V13_BUILD_STDERR_SHA256,
            ),
            (
                self.records.path.join("deployment.stdout"),
                deployment_stdout.as_slice(),
                PRIOR_V13_DEPLOYMENT_STDOUT_SHA256,
            ),
            (
                self.records.path.join("deployment.stderr"),
                deployment_stderr.as_slice(),
                PRIOR_V13_DEPLOYMENT_STDERR_SHA256,
            ),
            (
                self.records.path.join("rollback-reserve.bin"),
                rollback_reserve.as_slice(),
                PRIOR_V13_ROLLBACK_RESERVE_SHA256,
            ),
        ] {
            if sha256_bytes(bytes)? != expected {
                return Err(ControllerError(format!(
                    "prior v13 anchored record changed: {}",
                    path.display()
                )));
            }
        }
        if !deployment_stdout.is_empty() || deployment_stderr != PRIOR_V13_DEPLOYMENT_STDERR {
            return Err(ControllerError(
                "prior v13 deployment-verifier failure evidence changed".to_owned(),
            ));
        }
        if !rollback_reserve.is_empty() {
            return Err(ControllerError(
                "prior v13 rollback reserve was not durably released".to_owned(),
            ));
        }
        let rollback_reserve_metadata = self.rollback_reserve.metadata()?;
        if rollback_reserve_metadata.dev() != PRIOR_V13_ROLLBACK_RESERVE_DEVICE
            || rollback_reserve_metadata.ino() != PRIOR_V13_ROLLBACK_RESERVE_INODE
        {
            return Err(ControllerError(
                "prior v13 rollback reserve inode changed".to_owned(),
            ));
        }
        ...
        if archive_metadata.len() != PRIOR_V13_SOURCE_ARCHIVE_SIZE
            || sha256_bytes(&source_archive)? != PRIOR_V13_SOURCE_ARCHIVE_SHA256
        {
            return Err(ControllerError(
                "prior v13 source archive differs from the reviewed rolled-back attempt".to_owned(),
            ));
        }
        let snapshot_executable = read_opened_regular(
            &self.snapshot_executable,
        ...
        {
            return Err(ControllerError(
                "prior v13 offline legacy snapshot changed".to_owned(),
            ));
        }
        let staged_plist = read_opened_regular(
            &self.staged_plist,
        ...
        if sha256_file(&self.staged_app.path.join("Contents/MacOS/CaptureServer"))?
            != PRIOR_V13_STAGED_EXECUTABLE_SHA256
            || sha256_file(&self.failed_app.path.join("Contents/MacOS/CaptureServer"))?
                != PRIOR_V13_STAGED_EXECUTABLE_SHA256
            || sha256_bytes(&staged_plist)? != PRIOR_V13_STAGED_PLIST_SHA256
            || sha256_bytes(&failed_plist)? != PRIOR_V13_STAGED_PLIST_SHA256
        {
            return Err(ControllerError(
                "prior v13 staged or archived artifact hash changed".to_owned(),
            ));
        }
        let staged_app_manifest = directory_manifest(&self.staged_app.path)?;
        let failed_app_manifest = directory_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_app_manifest.as_bytes())? != PRIOR_V13_STAGED_APP_MANIFEST_SHA256
            || failed_app_manifest != staged_app_manifest
        {
            return Err(ControllerError(
                "prior v13 staged or archived full app manifest changed".to_owned(),
            ));
        }
        ...
        if sha256_bytes(staged_symlinks.as_bytes())? != PRIOR_V13_SYMLINK_TARGET_MANIFEST_SHA256
            || failed_symlinks != staged_symlinks
        {
            return Err(ControllerError(
                "prior v13 staged or archived symlink target changed".to_owned(),
            ));
        }
        ...
        if sha256_bytes(staged_xattrs.as_bytes())? != PRIOR_V13_STAGED_APP_XATTRS_SHA256
            || sha256_bytes(failed_xattrs.as_bytes())? != PRIOR_V13_FAILED_APP_XATTRS_SHA256
        {
            return Err(ControllerError(
                "prior v13 staged or archived app xattrs changed".to_owned(),
            ));
        }
        if staged_plist != failed_plist {
            return Err(ControllerError(
                "prior v13 archived plist differs from its staged artifact".to_owned(),
            ));
        }
...
fn validate_prior_v13_rolledback_retry(
    private_root: &PinnedDirectory,
) -> Result<PriorV13RetryGuard> {
    for residue in [
        PRIOR_V13_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V13_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V13_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        ...
        {
            return Err(ControllerError(format!(
                "prior v13 active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    let pointer =
        open_required_pinned_regular(private_root, PRIOR_V13_ACTIVE_TRANSACTION_NAME, 0o600)?;
    let pointer_bytes = read_opened_regular(
        &pointer,
        &private_root.path.join(PRIOR_V13_ACTIVE_TRANSACTION_NAME),
        0o600,
    )?;
    if pointer_bytes != PRIOR_V13_ACTIVE_RECORD {
        return Err(ControllerError(
            "prior v13 active pointer is not the exact reviewed record".to_owned(),
        ));
    }
    let evidence_path = parse_active_record(&pointer_bytes)?;
    if evidence_path != Path::new(PRIOR_V13_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v13 active pointer resolved to unexpected evidence".to_owned(),
        ));
    }
    ...
    let records = evidence
        .try_open_directory_child("records", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v13 evidence lacks records".to_owned()))?;
    let legacy_snapshot = evidence
        .try_open_directory_child("legacy-snapshot", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v13 evidence lacks legacy snapshot".to_owned()))?;
    let failed_new = evidence
        .try_open_directory_child("failed-new", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v13 evidence lacks failed-new".to_owned()))?;
    let failed_app = failed_new
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v13 evidence lacks archived app".to_owned()))?;
    let staged = evidence
        .try_open_directory_child("staged", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v13 evidence lacks staged directory".to_owned()))?;
    let staged_app = staged
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v13 evidence lacks staged app".to_owned()))?;
    let source_export = evidence
        .try_open_directory_child("source-export", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v13 evidence lacks source export directory".to_owned())
        })?;
    let scratch = evidence
        .try_open_directory_child("swiftpm-scratch", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v13 evidence lacks SwiftPM scratch directory".to_owned())
        })?;
    let journal = open_required_pinned_regular(&evidence, "journal.log", 0o600)?;
    let result = open_required_pinned_regular(&records, "result.txt", 0o600)?;
    let provenance = open_required_pinned_regular(&records, "provenance.txt", 0o600)?;
    ...
    let build_stdout = open_required_pinned_regular(&records, "build.stdout", 0o600)?;
    let build_stderr = open_required_pinned_regular(&records, "build.stderr", 0o600)?;
    let deployment_stdout = open_required_pinned_regular(&records, "deployment.stdout", 0o600)?;
    let deployment_stderr = open_required_pinned_regular(&records, "deployment.stderr", 0o600)?;
    let rollback_reserve = open_required_pinned_regular(&records, "rollback-reserve.bin", 0o600)?;
    let staged_plist =
        open_required_pinned_regular(&staged, "org.example.opensteamer.worldwide.plist", 0o600)?;
    let failed_plist = open_required_pinned_regular(
    ...
    let tag = guard
        ...
        .file_name()
        .and_then(OsStr::to_str)
        .ok_or_else(|| ControllerError("prior v13 evidence tag is not UTF-8".to_owned()))?;
    for residue in [
        Path::new(APPLICATIONS_DIRECTORY).join(format!(".opensteamer-disabled-v13-{tag}")),
        Path::new(APPLICATIONS_DIRECTORY).join(format!(".opensteamer-install-hold-{tag}")),
        Path::new("/Users/ahmed/Library/LaunchAgents").join(format!(
            ".org.example.opensteamer.worldwide.plist.disabled-v13-{tag}"
        )),
        Path::new("/Users/ahmed/Library/LaunchAgents").join(format!(
            ".org.example.opensteamer.worldwide.plist.install-{tag}"
        )),
        ...
        if entry_exists(&residue)? {
            return Err(ControllerError(format!(
                "prior v13 rollback residue remains at {}",
                residue.display()
            )));
        }
    }
...
fn validate_prior_v14_rolledback_records(
    evidence: &Path,
    journal: &[u8],
    result: &[u8],
    provenance: &[u8],
) -> Result<()> {
    if evidence != Path::new(PRIOR_V14_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v14 pointer does not name the exact reviewed evidence".to_owned(),
        ));
    }
    if journal != PRIOR_V14_FINAL_JOURNAL {
        return Err(ControllerError(
            "prior v14 journal is not the exact reviewed missing-cmp rollback".to_owned(),
        ));
    }
    if result != PRIOR_V14_FINAL_RESULT {
        return Err(ControllerError(
            "prior v14 result is not the exact reviewed rolled-back outcome".to_owned(),
        ));
    }
    if provenance != PRIOR_V14_PROVENANCE {
        return Err(ControllerError(
            "prior v14 provenance is not the exact reviewed record".to_owned(),
        ));
    }
    Ok(())
}

struct PriorV14RetryGuard {
    pointer: File,
    evidence: PinnedDirectory,
    records: PinnedDirectory,
    legacy_snapshot: PinnedDirectory,
...
impl PriorV14RetryGuard {
    fn journal_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            (
                "prior_v14_active_sha256",
                PRIOR_V14_ACTIVE_SHA256.to_owned(),
            ),
            (
                "prior_v14_journal_sha256",
                PRIOR_V14_FINAL_JOURNAL_SHA256.to_owned(),
            ),
            (
                "prior_v14_result_sha256",
                PRIOR_V14_FINAL_RESULT_SHA256.to_owned(),
            ),
            (
                "prior_v14_source_archive_sha256",
                PRIOR_V14_SOURCE_ARCHIVE_SHA256.to_owned(),
            ),
            (
                "prior_v14_source_commit",
                PRIOR_V14_SOURCE_COMMIT.to_owned(),
            ),
            ("prior_v14_source_tree", PRIOR_V14_SOURCE_TREE.to_owned()),
            (
                "prior_v14_provenance_sha256",
                PRIOR_V14_PROVENANCE_SHA256.to_owned(),
            ),
            (
                "prior_v14_legacy_executable_sha256",
                LEGACY_EXECUTABLE_SHA256.to_owned(),
            ),
            (
                "prior_v14_legacy_plist_sha256",
                LEGACY_PLIST_SHA256.to_owned(),
            ),
        ]
    }
    ...
    fn revalidate(&self, private_root: &PinnedDirectory) -> Result<()> {
        ...
        private_root.ensure_file_at_name(PRIOR_V14_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        let pointer_path = private_root.path.join(PRIOR_V14_ACTIVE_TRANSACTION_NAME);
        let pointer = read_opened_regular(&self.pointer, &pointer_path, 0o600)?;
        if pointer != PRIOR_V14_ACTIVE_RECORD || sha256_bytes(&pointer)? != PRIOR_V14_ACTIVE_SHA256
        {
            return Err(ControllerError(
                "prior v14 active pointer changed during retry proof".to_owned(),
            ));
        }
        private_root.ensure_file_at_name(PRIOR_V14_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        ...
        validate_prior_v14_rolledback_records(&self.evidence.path, &journal, &result, &provenance)?;
        if tree_manifest(&self.source_export.path)?.as_bytes() != source_export_manifest {
            return Err(ControllerError(
                "prior v14 source export differs from its exact reviewed manifest".to_owned(),
            ));
        }
        if tree_manifest(Path::new(LEGACY_APP))?.as_bytes() != legacy_manifest {
            return Err(ControllerError(
                "live legacy app differs from the exact prior v14 snapshot manifest".to_owned(),
            ));
        }
        if capture_legacy_xattrs()?.as_bytes() != legacy_xattrs {
            return Err(ControllerError(
                "live legacy app xattrs differ from the exact prior v14 snapshot".to_owned(),
            ));
        }
        if sha256_bytes(&journal)? != PRIOR_V14_FINAL_JOURNAL_SHA256
            || sha256_bytes(&result)? != PRIOR_V14_FINAL_RESULT_SHA256
            || sha256_bytes(&provenance)? != PRIOR_V14_PROVENANCE_SHA256
        {
            return Err(ControllerError(
                "prior v14 journal, result, or provenance hash changed during retry proof"
                    .to_owned(),
            ));
        }
        for (path, bytes, expected) in [
            ...
            if sha256_bytes(bytes)? != expected {
                return Err(ControllerError(format!(
                    "prior v14 anchored record changed: {}",
                    path.display()
                )));
            }
        }
        if !deployment_stdout.is_empty() || deployment_stderr != PRIOR_V14_DEPLOYMENT_STDERR {
            return Err(ControllerError(
                "prior v14 deployment-verifier failure evidence changed".to_owned(),
            ));
        }
        if !rollback_reserve.is_empty() {
            return Err(ControllerError(
                "prior v14 rollback reserve was not durably released".to_owned(),
            ));
        }
        let rollback_reserve_metadata = self.rollback_reserve.metadata()?;
        if rollback_reserve_metadata.dev() != PRIOR_V14_ROLLBACK_RESERVE_DEVICE
            || rollback_reserve_metadata.ino() != PRIOR_V14_ROLLBACK_RESERVE_INODE
        {
            return Err(ControllerError(
                "prior v14 rollback reserve inode changed".to_owned(),
            ));
        }
        ...
        if archive_metadata.len() != PRIOR_V14_SOURCE_ARCHIVE_SIZE
            || sha256_bytes(&source_archive)? != PRIOR_V14_SOURCE_ARCHIVE_SHA256
        {
            return Err(ControllerError(
                "prior v14 source archive differs from the reviewed rolled-back attempt".to_owned(),
            ));
        }
        let snapshot_executable = read_opened_regular(
            &self.snapshot_executable,
        ...
        {
            return Err(ControllerError(
                "prior v14 offline legacy snapshot changed".to_owned(),
            ));
        }
        let staged_plist = read_opened_regular(
            &self.staged_plist,
        ...
        if sha256_file(&self.staged_app.path.join("Contents/MacOS/CaptureServer"))?
            ...
            || sha256_file(&self.failed_app.path.join("Contents/MacOS/CaptureServer"))?
                != PRIOR_V14_STAGED_EXECUTABLE_SHA256
            || sha256_bytes(&staged_plist)? != PRIOR_V14_STAGED_PLIST_SHA256
            || sha256_bytes(&failed_plist)? != PRIOR_V14_STAGED_PLIST_SHA256
        {
            return Err(ControllerError(
                "prior v14 staged or archived artifact hash changed".to_owned(),
            ));
        }
        let staged_app_manifest = directory_manifest(&self.staged_app.path)?;
        let failed_app_manifest = directory_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_app_manifest.as_bytes())? != PRIOR_V14_STAGED_APP_MANIFEST_SHA256
            || failed_app_manifest != staged_app_manifest
        {
            return Err(ControllerError(
                "prior v14 staged or archived full app manifest changed".to_owned(),
            ));
        }
        let staged_symlinks = symlink_target_manifest(&self.staged_app.path)?;
        let failed_symlinks = symlink_target_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_symlinks.as_bytes())? != PRIOR_V14_SYMLINK_TARGET_MANIFEST_SHA256
            || failed_symlinks != staged_symlinks
        {
            return Err(ControllerError(
                "prior v14 staged or archived symlink target changed".to_owned(),
            ));
        }
        let staged_xattrs = capture_tree_xattrs_until(
            &self.staged_app.path,
        ...
        if sha256_bytes(staged_xattrs.as_bytes())? != PRIOR_V14_STAGED_APP_XATTRS_SHA256
            || sha256_bytes(failed_xattrs.as_bytes())? != PRIOR_V14_FAILED_APP_XATTRS_SHA256
        {
            return Err(ControllerError(
                "prior v14 staged or archived app xattrs changed".to_owned(),
            ));
        }
        if staged_plist != failed_plist {
            return Err(ControllerError(
                "prior v14 archived plist differs from its staged artifact".to_owned(),
            ));
        }
...
fn validate_prior_v14_rolledback_retry(
    private_root: &PinnedDirectory,
) -> Result<PriorV14RetryGuard> {
    for residue in [
        PRIOR_V14_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V14_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V14_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        ...
        {
            return Err(ControllerError(format!(
                "prior v14 active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    let pointer =
        open_required_pinned_regular(private_root, PRIOR_V14_ACTIVE_TRANSACTION_NAME, 0o600)?;
    let pointer_bytes = read_opened_regular(
        &pointer,
        &private_root.path.join(PRIOR_V14_ACTIVE_TRANSACTION_NAME),
        0o600,
    )?;
    if pointer_bytes != PRIOR_V14_ACTIVE_RECORD {
        return Err(ControllerError(
            "prior v14 active pointer is not the exact reviewed record".to_owned(),
        ));
    }
    let evidence_path = parse_active_record(&pointer_bytes)?;
    if evidence_path != Path::new(PRIOR_V14_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v14 active pointer resolved to unexpected evidence".to_owned(),
        ));
    }
    ...
    let records = evidence
        .try_open_directory_child("records", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v14 evidence lacks records".to_owned()))?;
    let legacy_snapshot = evidence
        .try_open_directory_child("legacy-snapshot", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v14 evidence lacks legacy snapshot".to_owned()))?;
    let failed_new = evidence
        .try_open_directory_child("failed-new", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v14 evidence lacks failed-new".to_owned()))?;
    let failed_app = failed_new
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v14 evidence lacks archived app".to_owned()))?;
    let staged = evidence
        .try_open_directory_child("staged", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v14 evidence lacks staged directory".to_owned()))?;
    let staged_app = staged
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v14 evidence lacks staged app".to_owned()))?;
    let source_export = evidence
        .try_open_directory_child("source-export", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v14 evidence lacks source export directory".to_owned())
        })?;
    let scratch = evidence
        .try_open_directory_child("swiftpm-scratch", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v14 evidence lacks SwiftPM scratch directory".to_owned())
        })?;
    let journal = open_required_pinned_regular(&evidence, "journal.log", 0o600)?;
    let result = open_required_pinned_regular(&records, "result.txt", 0o600)?;
    let provenance = open_required_pinned_regular(&records, "provenance.txt", 0o600)?;
...
fn validate_prior_v15_rolledback_records(
    evidence: &Path,
    journal: &[u8],
    result: &[u8],
    provenance: &[u8],
) -> Result<()> {
    if evidence != Path::new(PRIOR_V15_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v15 pointer does not name the exact reviewed evidence".to_owned(),
        ));
    }
    if journal.len() != PRIOR_V15_FINAL_JOURNAL_SIZE
        || journal.iter().filter(|byte| **byte == b'\n').count() != PRIOR_V15_FINAL_JOURNAL_LINES
        || sha256_bytes(journal)? != PRIOR_V15_FINAL_JOURNAL_SHA256
        || !journal.starts_with(b"OPENSTEAMER_MIGRATION_JOURNAL_V15\n")
        || !journal
            .windows(PRIOR_V15_PRECUTOVER_JOURNAL_LINE.len())
            .any(|window| window == PRIOR_V15_PRECUTOVER_JOURNAL_LINE)
        || !journal
            .windows(PRIOR_V15_GENERATION_JOURNAL_LINE.len())
            .any(|window| window == PRIOR_V15_GENERATION_JOURNAL_LINE)
        || !journal.ends_with(PRIOR_V15_ROLLBACK_JOURNAL_TAIL)
    {
        return Err(ControllerError(
            "prior v15 journal is not the exact reviewed readiness-race rollback".to_owned(),
        ));
    }
    if result != PRIOR_V15_FINAL_RESULT || sha256_bytes(result)? != PRIOR_V15_FINAL_RESULT_SHA256 {
        return Err(ControllerError(
            "prior v15 result is not the exact reviewed rolled-back outcome".to_owned(),
        ));
    }
    if provenance != PRIOR_V15_PROVENANCE
        || sha256_bytes(provenance)? != PRIOR_V15_PROVENANCE_SHA256
    {
        return Err(ControllerError(
            "prior v15 provenance is not the exact reviewed record".to_owned(),
        ));
    }
    Ok(())
}

fn require_prior_v15_deployment_records_absent(records: &PinnedDirectory) -> Result<()> {
    for name in ["deployment.stdout", "deployment.stderr"] {
        if records.open_existing_regular(name, false)?.is_some() {
            return Err(ControllerError(format!(
                "prior v15 must not contain a deployment-verifier record: {name}"
            )));
        }
    }
    Ok(())
...
impl PriorV15RetryGuard {
    fn journal_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            (
                "prior_v15_active_sha256",
                PRIOR_V15_ACTIVE_SHA256.to_owned(),
            ),
            (
                "prior_v15_journal_sha256",
                PRIOR_V15_FINAL_JOURNAL_SHA256.to_owned(),
            ),
            (
                "prior_v15_result_sha256",
                PRIOR_V15_FINAL_RESULT_SHA256.to_owned(),
            ),
            (
                "prior_v15_source_archive_sha256",
                PRIOR_V15_SOURCE_ARCHIVE_SHA256.to_owned(),
            ),
            (
                "prior_v15_source_commit",
                PRIOR_V15_SOURCE_COMMIT.to_owned(),
            ),
            ("prior_v15_source_tree", PRIOR_V15_SOURCE_TREE.to_owned()),
            (
                "prior_v15_provenance_sha256",
                PRIOR_V15_PROVENANCE_SHA256.to_owned(),
            ),
            (
                "prior_v15_legacy_executable_sha256",
                LEGACY_EXECUTABLE_SHA256.to_owned(),
            ),
            (
                "prior_v15_legacy_plist_sha256",
                LEGACY_PLIST_SHA256.to_owned(),
            ),
        ]
    }
    ...
    fn revalidate(&self, private_root: &PinnedDirectory) -> Result<()> {
        ...
        private_root.ensure_file_at_name(PRIOR_V15_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        let pointer_path = private_root.path.join(PRIOR_V15_ACTIVE_TRANSACTION_NAME);
        let pointer = read_opened_regular(&self.pointer, &pointer_path, 0o600)?;
        if pointer != PRIOR_V15_ACTIVE_RECORD || sha256_bytes(&pointer)? != PRIOR_V15_ACTIVE_SHA256
        {
            return Err(ControllerError(
                "prior v15 active pointer changed during retry proof".to_owned(),
            ));
        }
        private_root.ensure_file_at_name(PRIOR_V15_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        ...
        require_prior_v15_deployment_records_absent(&self.records)?;
        require_exact_directory_entries(
            &self.legacy_snapshot,
            &["CaptureServer", "com.elamin.audiostreamer.worldwide.plist"],
        )?;
        ...
        if build_stdout.len() != PRIOR_V15_BUILD_STDOUT_SIZE
            || build_stderr.len() != PRIOR_V15_BUILD_STDERR_SIZE
        {
            return Err(ControllerError(
                "prior v15 build record sizes changed".to_owned(),
            ));
        }
        let rollback_reserve = read_opened_regular(
            &self.rollback_reserve,
        ...
        validate_prior_v15_rolledback_records(&self.evidence.path, &journal, &result, &provenance)?;
        if tree_manifest(&self.source_export.path)?.as_bytes() != source_export_manifest {
            return Err(ControllerError(
                "prior v15 source export differs from its exact reviewed manifest".to_owned(),
            ));
        }
        if tree_manifest(Path::new(LEGACY_APP))?.as_bytes() != legacy_manifest {
            return Err(ControllerError(
                "live legacy app differs from the exact prior v15 snapshot manifest".to_owned(),
            ));
        }
        if capture_legacy_xattrs()?.as_bytes() != legacy_xattrs {
            return Err(ControllerError(
                "live legacy app xattrs differ from the exact prior v15 snapshot".to_owned(),
            ));
        }
        for (path, bytes, expected) in [
            (
            ...
            if sha256_bytes(bytes)? != expected {
                return Err(ControllerError(format!(
                    "prior v15 anchored record changed: {}",
                    path.display()
                )));
            }
        }
        if !rollback_reserve.is_empty() {
            return Err(ControllerError(
                "prior v15 rollback reserve was not durably released".to_owned(),
            ));
        }
        let rollback_reserve_metadata = self.rollback_reserve.metadata()?;
        if rollback_reserve_metadata.dev() != PRIOR_V15_ROLLBACK_RESERVE_DEVICE
            || rollback_reserve_metadata.ino() != PRIOR_V15_ROLLBACK_RESERVE_INODE
        {
            return Err(ControllerError(
                "prior v15 rollback reserve inode changed".to_owned(),
            ));
        }
        ...
        if archive_metadata.len() != PRIOR_V15_SOURCE_ARCHIVE_SIZE
            || sha256_bytes(&source_archive)? != PRIOR_V15_SOURCE_ARCHIVE_SHA256
        {
            return Err(ControllerError(
                "prior v15 source archive differs from the reviewed rolled-back attempt".to_owned(),
            ));
        }
        let snapshot_executable = read_opened_regular(
            &self.snapshot_executable,
        ...
        {
            return Err(ControllerError(
                "prior v15 offline legacy snapshot changed".to_owned(),
            ));
        }
        let staged_plist = read_opened_regular(
            &self.staged_plist,
        ...
        if sha256_file(&self.staged_app.path.join("Contents/MacOS/CaptureServer"))?
            ...
            || sha256_file(&self.failed_app.path.join("Contents/MacOS/CaptureServer"))?
                != PRIOR_V15_STAGED_EXECUTABLE_SHA256
            || sha256_bytes(&staged_plist)? != PRIOR_V15_STAGED_PLIST_SHA256
            || sha256_bytes(&failed_plist)? != PRIOR_V15_STAGED_PLIST_SHA256
        {
            return Err(ControllerError(
                "prior v15 staged or archived artifact hash changed".to_owned(),
            ));
        }
        let staged_app_manifest = directory_manifest(&self.staged_app.path)?;
        let failed_app_manifest = directory_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_app_manifest.as_bytes())? != PRIOR_V15_STAGED_APP_MANIFEST_SHA256
            || failed_app_manifest != staged_app_manifest
        {
            return Err(ControllerError(
                "prior v15 staged or archived full app manifest changed".to_owned(),
            ));
        }
        let staged_symlinks = symlink_target_manifest(&self.staged_app.path)?;
        let failed_symlinks = symlink_target_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_symlinks.as_bytes())? != PRIOR_V15_SYMLINK_TARGET_MANIFEST_SHA256
            || failed_symlinks != staged_symlinks
        {
            return Err(ControllerError(
                "prior v15 staged or archived symlink target changed".to_owned(),
            ));
        }
        let staged_xattrs = capture_tree_xattrs_until(
            &self.staged_app.path,
        ...
        if sha256_bytes(staged_xattrs.as_bytes())? != PRIOR_V15_STAGED_APP_XATTRS_SHA256
            || sha256_bytes(failed_xattrs.as_bytes())? != PRIOR_V15_FAILED_APP_XATTRS_SHA256
        {
            return Err(ControllerError(
                "prior v15 staged or archived app xattrs changed".to_owned(),
            ));
        }
        if staged_plist != failed_plist {
            return Err(ControllerError(
                "prior v15 archived plist differs from its staged artifact".to_owned(),
            ));
        }
...
fn validate_prior_v15_rolledback_retry(
    private_root: &PinnedDirectory,
) -> Result<PriorV15RetryGuard> {
    for residue in [
        PRIOR_V15_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V15_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V15_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        ...
        {
            return Err(ControllerError(format!(
                "prior v15 active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    let pointer =
        open_required_pinned_regular(private_root, PRIOR_V15_ACTIVE_TRANSACTION_NAME, 0o600)?;
    let pointer_bytes = read_opened_regular(
        &pointer,
        &private_root.path.join(PRIOR_V15_ACTIVE_TRANSACTION_NAME),
        0o600,
    )?;
    if pointer_bytes != PRIOR_V15_ACTIVE_RECORD {
        return Err(ControllerError(
            "prior v15 active pointer is not the exact reviewed record".to_owned(),
        ));
    }
    let evidence_path = parse_active_record(&pointer_bytes)?;
    if evidence_path != Path::new(PRIOR_V15_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v15 active pointer resolved to unexpected evidence".to_owned(),
        ));
    }
    ...
    let records = evidence
        .try_open_directory_child("records", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v15 evidence lacks records".to_owned()))?;
    let legacy_snapshot = evidence
        .try_open_directory_child("legacy-snapshot", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v15 evidence lacks legacy snapshot".to_owned()))?;
    let failed_new = evidence
        .try_open_directory_child("failed-new", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v15 evidence lacks failed-new".to_owned()))?;
    let failed_app = failed_new
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v15 evidence lacks archived app".to_owned()))?;
    let staged = evidence
        .try_open_directory_child("staged", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v15 evidence lacks staged directory".to_owned()))?;
    let staged_app = staged
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v15 evidence lacks staged app".to_owned()))?;
    let source_export = evidence
        .try_open_directory_child("source-export", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v15 evidence lacks source export directory".to_owned())
        })?;
    let scratch = evidence
        .try_open_directory_child("swiftpm-scratch", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v15 evidence lacks SwiftPM scratch directory".to_owned())
        })?;
    let journal = open_required_pinned_regular(&evidence, "journal.log", 0o600)?;
    let result = open_required_pinned_regular(&records, "result.txt", 0o600)?;
    let provenance = open_required_pinned_regular(&records, "provenance.txt", 0o600)?;
    ...
    let build_stdout = open_required_pinned_regular(&records, "build.stdout", 0o600)?;
    let build_stderr = open_required_pinned_regular(&records, "build.stderr", 0o600)?;
    require_prior_v15_deployment_records_absent(&records)?;
    let rollback_reserve = open_required_pinned_regular(&records, "rollback-reserve.bin", 0o600)?;
    let staged_plist =
        open_required_pinned_regular(&staged, "org.example.opensteamer.worldwide.plist", 0o600)?;
    let failed_plist = open_required_pinned_regular(
...
fn validate_prior_v17_rolledback_records(
    evidence: &Path,
    journal: &[u8],
    result: &[u8],
    provenance: &[u8],
    ...
    if evidence != Path::new(PRIOR_V17_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v17 pointer does not name the exact reviewed evidence".to_owned(),
        ));
    }
    if journal.len() != PRIOR_V17_FINAL_JOURNAL_SIZE
        || journal.iter().filter(|byte| **byte == b'\n').count() != PRIOR_V17_FINAL_JOURNAL_LINES
        || sha256_bytes(journal)? != PRIOR_V17_FINAL_JOURNAL_SHA256
        || !journal.starts_with(b"OPENSTEAMER_MIGRATION_JOURNAL_V17\n")
        || !journal
            .windows(PRIOR_V17_PRECUTOVER_JOURNAL_LINE.len())
            .any(|window| window == PRIOR_V17_PRECUTOVER_JOURNAL_LINE)
        || !journal
            .windows(PRIOR_V17_GENERATION_JOURNAL_LINE.len())
            .any(|window| window == PRIOR_V17_GENERATION_JOURNAL_LINE)
        || !journal.ends_with(PRIOR_V17_ROLLBACK_JOURNAL_TAIL)
    {
        return Err(ControllerError(
            "prior v17 journal is not the exact reviewed status-141 full rollback".to_owned(),
        ));
    }
    if result != PRIOR_V17_FINAL_RESULT || sha256_bytes(result)? != PRIOR_V17_FINAL_RESULT_SHA256 {
        return Err(ControllerError(
            "prior v17 result is not the exact reviewed rolled-back outcome".to_owned(),
        ));
    }
    if provenance != PRIOR_V17_PROVENANCE
        || sha256_bytes(provenance)? != PRIOR_V17_PROVENANCE_SHA256
    {
        return Err(ControllerError(
            "prior v17 provenance is not the exact reviewed record".to_owned(),
        ));
    }
    if deployment_stdout.len() != PRIOR_V17_DEPLOYMENT_STDOUT_SIZE
    ...
    {
        return Err(ControllerError(
            "prior v17 deployment records are not the exact reviewed codesign/awk SIGPIPE failure"
                .to_owned(),
        ));
    }
    Ok(())
...
impl PriorV17RetryGuard {
    fn journal_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            (
                "prior_v17_active_sha256",
                PRIOR_V17_ACTIVE_SHA256.to_owned(),
            ),
            (
                "prior_v17_journal_sha256",
                PRIOR_V17_FINAL_JOURNAL_SHA256.to_owned(),
            ),
            (
                "prior_v17_result_sha256",
                PRIOR_V17_FINAL_RESULT_SHA256.to_owned(),
            ),
            (
                "prior_v17_source_archive_sha256",
                PRIOR_V17_SOURCE_ARCHIVE_SHA256.to_owned(),
            ),
            (
                "prior_v17_source_commit",
                PRIOR_V17_SOURCE_COMMIT.to_owned(),
            ),
            ("prior_v17_source_tree", PRIOR_V17_SOURCE_TREE.to_owned()),
            (
                "prior_v17_provenance_sha256",
                PRIOR_V17_PROVENANCE_SHA256.to_owned(),
            ),
            (
                "prior_v17_legacy_executable_sha256",
                LEGACY_EXECUTABLE_SHA256.to_owned(),
            ),
            (
                "prior_v17_legacy_plist_sha256",
                LEGACY_PLIST_SHA256.to_owned(),
            ),
            (
                "prior_v17_deployment_stderr_sha256",
                PRIOR_V17_DEPLOYMENT_STDERR_SHA256.to_owned(),
            ),
        ]
    }
    ...
    fn revalidate(&self, private_root: &PinnedDirectory) -> Result<()> {
        ...
        private_root.ensure_file_at_name(PRIOR_V17_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        let pointer_path = private_root.path.join(PRIOR_V17_ACTIVE_TRANSACTION_NAME);
        let pointer = read_opened_regular(&self.pointer, &pointer_path, 0o600)?;
        if pointer != PRIOR_V17_ACTIVE_RECORD || sha256_bytes(&pointer)? != PRIOR_V17_ACTIVE_SHA256
        {
            return Err(ControllerError(
                "prior v17 active pointer changed during retry proof".to_owned(),
            ));
        }
        private_root.ensure_file_at_name(PRIOR_V17_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        self.revalidate_directories()?;
        ...
        if build_stdout.len() != PRIOR_V17_BUILD_STDOUT_SIZE
            || build_stderr.len() != PRIOR_V17_BUILD_STDERR_SIZE
        {
            return Err(ControllerError(
                "prior v17 build record sizes changed".to_owned(),
            ));
        }
        ...
        if tree_manifest(&self.source_export.path)?.as_bytes() != source_export_manifest {
            return Err(ControllerError(
                "prior v17 source export differs from its exact reviewed manifest".to_owned(),
            ));
        }
        if tree_manifest(Path::new(LEGACY_APP))?.as_bytes() != legacy_manifest {
            return Err(ControllerError(
                "live legacy app differs from the exact prior v17 snapshot manifest".to_owned(),
            ));
        }
        if capture_legacy_xattrs()?.as_bytes() != legacy_xattrs {
            return Err(ControllerError(
                "live legacy app xattrs differ from the exact prior v17 snapshot".to_owned(),
            ));
        }
        for (path, bytes, expected) in [
            (
            ...
            if sha256_bytes(bytes)? != expected {
                return Err(ControllerError(format!(
                    "prior v17 anchored record changed: {}",
                    path.display()
                )));
            }
        }
        if !rollback_reserve.is_empty() {
            return Err(ControllerError(
                "prior v17 rollback reserve was not durably released".to_owned(),
            ));
        }
        let reserve_metadata = self.rollback_reserve.metadata()?;
        if reserve_metadata.dev() != PRIOR_V17_ROLLBACK_RESERVE_DEVICE
            || reserve_metadata.ino() != PRIOR_V17_ROLLBACK_RESERVE_INODE
        {
            return Err(ControllerError(
                "prior v17 rollback reserve inode changed".to_owned(),
            ));
        }
        ...
        if archive_metadata.len() != PRIOR_V17_SOURCE_ARCHIVE_SIZE
            || sha256_bytes(&source_archive)? != PRIOR_V17_SOURCE_ARCHIVE_SHA256
        {
            return Err(ControllerError(
                "prior v17 source archive differs from the reviewed rolled-back attempt".to_owned(),
            ));
        }
        let snapshot_executable = read_opened_regular(
            &self.snapshot_executable,
        ...
        {
            return Err(ControllerError(
                "prior v17 offline legacy snapshot changed".to_owned(),
            ));
        }
        ...
        if sha256_file(&self.staged_app.path.join("Contents/MacOS/CaptureServer"))?
            ...
            || sha256_file(&self.failed_app.path.join("Contents/MacOS/CaptureServer"))?
                != PRIOR_V17_STAGED_EXECUTABLE_SHA256
            || sha256_bytes(&staged_plist)? != PRIOR_V17_STAGED_PLIST_SHA256
            || sha256_bytes(&failed_plist)? != PRIOR_V17_STAGED_PLIST_SHA256
        {
            return Err(ControllerError(
                "prior v17 staged or archived artifact hash changed".to_owned(),
            ));
        }
        let staged_app_manifest = directory_manifest(&self.staged_app.path)?;
        let failed_app_manifest = directory_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_app_manifest.as_bytes())? != PRIOR_V17_STAGED_APP_MANIFEST_SHA256
            || failed_app_manifest != staged_app_manifest
        {
            return Err(ControllerError(
                "prior v17 staged or archived full app manifest changed".to_owned(),
            ));
        }
        let staged_symlinks = symlink_target_manifest(&self.staged_app.path)?;
        let failed_symlinks = symlink_target_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_symlinks.as_bytes())? != PRIOR_V17_SYMLINK_TARGET_MANIFEST_SHA256
            || failed_symlinks != staged_symlinks
        {
            return Err(ControllerError(
                "prior v17 staged or archived symlink target changed".to_owned(),
            ));
        }
        let staged_xattrs = capture_tree_xattrs_until(
            &self.staged_app.path,
        ...
        if sha256_bytes(staged_xattrs.as_bytes())? != PRIOR_V17_STAGED_APP_XATTRS_SHA256
            || sha256_bytes(failed_xattrs.as_bytes())? != PRIOR_V17_FAILED_APP_XATTRS_SHA256
        {
            return Err(ControllerError(
                "prior v17 staged or archived app xattrs changed".to_owned(),
            ));
        }
        if staged_plist != failed_plist {
            return Err(ControllerError(
                "prior v17 archived plist differs from its staged artifact".to_owned(),
            ));
        }
...
fn validate_prior_v17_rolledback_retry(
    private_root: &PinnedDirectory,
) -> Result<PriorV17RetryGuard> {
    for residue in [
        PRIOR_V17_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V17_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V17_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        ...
        {
            return Err(ControllerError(format!(
                "prior v17 active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    let pointer =
        open_required_pinned_regular(private_root, PRIOR_V17_ACTIVE_TRANSACTION_NAME, 0o600)?;
    let pointer_bytes = read_opened_regular(
        &pointer,
        &private_root.path.join(PRIOR_V17_ACTIVE_TRANSACTION_NAME),
        0o600,
    )?;
    if pointer_bytes != PRIOR_V17_ACTIVE_RECORD
        || sha256_bytes(&pointer_bytes)? != PRIOR_V17_ACTIVE_SHA256
    {
        return Err(ControllerError(
            "prior v17 active pointer is not the exact reviewed record".to_owned(),
        ));
    }
    let evidence_path = parse_active_record(&pointer_bytes)?;
    if evidence_path != Path::new(PRIOR_V17_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v17 active pointer resolved to unexpected evidence".to_owned(),
        ));
    }
    ...
    let records = evidence
        .try_open_directory_child("records", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v17 evidence lacks records".to_owned()))?;
    let legacy_snapshot = evidence
        .try_open_directory_child("legacy-snapshot", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v17 evidence lacks legacy snapshot".to_owned()))?;
    let failed_new = evidence
        .try_open_directory_child("failed-new", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v17 evidence lacks failed-new".to_owned()))?;
    let failed_app = failed_new
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v17 evidence lacks archived app".to_owned()))?;
    let staged = evidence
        .try_open_directory_child("staged", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v17 evidence lacks staged directory".to_owned()))?;
    let staged_app = staged
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v17 evidence lacks staged app".to_owned()))?;
    let source_export = evidence
        .try_open_directory_child("source-export", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v17 evidence lacks source export directory".to_owned())
        })?;
    let scratch = evidence
        .try_open_directory_child("swiftpm-scratch", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v17 evidence lacks SwiftPM scratch directory".to_owned())
        })?;
    let guard = PriorV17RetryGuard {
        journal: open_required_pinned_regular(&evidence, "journal.log", 0o600)?,
        result: open_required_pinned_regular(&records, "result.txt", 0o600)?,
        provenance: open_required_pinned_regular(&records, "provenance.txt", 0o600)?,
        legacy_manifest: open_required_pinned_regular(
...
fn validate_prior_v18_rolledback_records(
    evidence: &Path,
    journal: &[u8],
    result: &[u8],
    provenance: &[u8],
    ...
    if evidence != Path::new(PRIOR_V18_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v18 pointer does not name the exact reviewed evidence".to_owned(),
        ));
    }
    if journal != PRIOR_V18_FINAL_JOURNAL_FIXTURE
        || journal.len() != PRIOR_V18_FINAL_JOURNAL_SIZE
        || journal.iter().filter(|byte| **byte == b'\n').count() != PRIOR_V18_FINAL_JOURNAL_LINES
        || sha256_bytes(journal)? != PRIOR_V18_FINAL_JOURNAL_SHA256
        || !journal.starts_with(b"OPENSTEAMER_MIGRATION_JOURNAL_V18\n")
        || !journal
            .windows(PRIOR_V18_PRECUTOVER_JOURNAL_LINE.len())
            .any(|window| window == PRIOR_V18_PRECUTOVER_JOURNAL_LINE)
        || !journal
            .windows(PRIOR_V18_GENERATION_JOURNAL_LINE.len())
            .any(|window| window == PRIOR_V18_GENERATION_JOURNAL_LINE)
        || !journal.ends_with(PRIOR_V18_ROLLBACK_JOURNAL_TAIL)
    {
        return Err(ControllerError(
            "prior v18 journal is not the exact reviewed trailing-ps-padding full rollback"
                .to_owned(),
        ));
    }
    if result != PRIOR_V18_FINAL_RESULT || sha256_bytes(result)? != PRIOR_V18_FINAL_RESULT_SHA256 {
        return Err(ControllerError(
            "prior v18 result is not the exact reviewed rolled-back outcome".to_owned(),
        ));
    }
    if provenance != PRIOR_V18_PROVENANCE
        || sha256_bytes(provenance)? != PRIOR_V18_PROVENANCE_SHA256
    {
        return Err(ControllerError(
            "prior v18 provenance is not the exact reviewed record".to_owned(),
        ));
    }
    if deployment_stdout.len() != PRIOR_V18_DEPLOYMENT_STDOUT_SIZE
    ...
    {
        return Err(ControllerError(
            "prior v18 deployment records are not the exact reviewed trailing ps lstart padding mismatch failure".to_owned(),
        ));
    }
    Ok(())
}

struct PriorV18RetryGuard {
    pointer: File,
    evidence: PinnedDirectory,
    records: PinnedDirectory,
    legacy_snapshot: PinnedDirectory,
...
impl PriorV18RetryGuard {
    fn journal_fields(&self) -> Vec<(&'static str, String)> {
        vec![
            (
                "prior_v18_active_sha256",
                PRIOR_V18_ACTIVE_SHA256.to_owned(),
            ),
            (
                "prior_v18_journal_sha256",
                PRIOR_V18_FINAL_JOURNAL_SHA256.to_owned(),
            ),
            (
                "prior_v18_result_sha256",
                PRIOR_V18_FINAL_RESULT_SHA256.to_owned(),
            ),
            (
                "prior_v18_source_archive_sha256",
                PRIOR_V18_SOURCE_ARCHIVE_SHA256.to_owned(),
            ),
            (
                "prior_v18_source_commit",
                PRIOR_V18_SOURCE_COMMIT.to_owned(),
            ),
            ("prior_v18_source_tree", PRIOR_V18_SOURCE_TREE.to_owned()),
            (
                "prior_v18_provenance_sha256",
                PRIOR_V18_PROVENANCE_SHA256.to_owned(),
            ),
            (
                "prior_v18_legacy_executable_sha256",
                LEGACY_EXECUTABLE_SHA256.to_owned(),
            ),
            (
                "prior_v18_legacy_plist_sha256",
                LEGACY_PLIST_SHA256.to_owned(),
            ),
            (
                "prior_v18_deployment_stderr_sha256",
                PRIOR_V18_DEPLOYMENT_STDERR_SHA256.to_owned(),
            ),
        ]
    }
    ...
    fn revalidate(&self, private_root: &PinnedDirectory) -> Result<()> {
        ...
        private_root.ensure_file_at_name(PRIOR_V18_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        let pointer_path = private_root.path.join(PRIOR_V18_ACTIVE_TRANSACTION_NAME);
        let pointer = read_opened_regular(&self.pointer, &pointer_path, 0o600)?;
        if pointer != PRIOR_V18_ACTIVE_RECORD || sha256_bytes(&pointer)? != PRIOR_V18_ACTIVE_SHA256
        {
            return Err(ControllerError(
                "prior v18 active pointer changed during retry proof".to_owned(),
            ));
        }
        private_root.ensure_file_at_name(PRIOR_V18_ACTIVE_TRANSACTION_NAME, &self.pointer)?;
        self.revalidate_directories()?;
        ...
        if build_stdout.len() != PRIOR_V18_BUILD_STDOUT_SIZE
            || build_stderr.len() != PRIOR_V18_BUILD_STDERR_SIZE
        {
            return Err(ControllerError(
                "prior v18 build record sizes changed".to_owned(),
            ));
        }
        ...
        if tree_manifest(&self.source_export.path)?.as_bytes() != source_export_manifest {
            return Err(ControllerError(
                "prior v18 source export differs from its exact reviewed manifest".to_owned(),
            ));
        }
        if tree_manifest(Path::new(LEGACY_APP))?.as_bytes() != legacy_manifest {
            return Err(ControllerError(
                "live legacy app differs from the exact prior v18 snapshot manifest".to_owned(),
            ));
        }
        if capture_legacy_xattrs()?.as_bytes() != legacy_xattrs {
            return Err(ControllerError(
                "live legacy app xattrs differ from the exact prior v18 snapshot".to_owned(),
            ));
        }
        for (path, bytes, expected) in [
            (
            ...
            if sha256_bytes(bytes)? != expected {
                return Err(ControllerError(format!(
                    "prior v18 anchored record changed: {}",
                    path.display()
                )));
            }
        }
        if !rollback_reserve.is_empty() {
            return Err(ControllerError(
                "prior v18 rollback reserve was not durably released".to_owned(),
            ));
        }
        let reserve_metadata = self.rollback_reserve.metadata()?;
        if reserve_metadata.dev() != PRIOR_V18_ROLLBACK_RESERVE_DEVICE
            || reserve_metadata.ino() != PRIOR_V18_ROLLBACK_RESERVE_INODE
        {
            return Err(ControllerError(
                "prior v18 rollback reserve inode changed".to_owned(),
            ));
        }
        ...
        if archive_metadata.len() != PRIOR_V18_SOURCE_ARCHIVE_SIZE
            || sha256_bytes(&source_archive)? != PRIOR_V18_SOURCE_ARCHIVE_SHA256
        {
            return Err(ControllerError(
                "prior v18 source archive differs from the reviewed rolled-back attempt".to_owned(),
            ));
        }
        let snapshot_executable = read_opened_regular(
            &self.snapshot_executable,
        ...
        {
            return Err(ControllerError(
                "prior v18 offline legacy snapshot changed".to_owned(),
            ));
        }
        ...
        if sha256_file(&self.staged_app.path.join("Contents/MacOS/CaptureServer"))?
            ...
            || sha256_file(&self.failed_app.path.join("Contents/MacOS/CaptureServer"))?
                != PRIOR_V18_STAGED_EXECUTABLE_SHA256
            || sha256_bytes(&staged_plist)? != PRIOR_V18_STAGED_PLIST_SHA256
            || sha256_bytes(&failed_plist)? != PRIOR_V18_STAGED_PLIST_SHA256
        {
            return Err(ControllerError(
                "prior v18 staged or archived artifact hash changed".to_owned(),
            ));
        }
        let staged_app_manifest = directory_manifest(&self.staged_app.path)?;
        let failed_app_manifest = directory_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_app_manifest.as_bytes())? != PRIOR_V18_STAGED_APP_MANIFEST_SHA256
            || failed_app_manifest != staged_app_manifest
        {
            return Err(ControllerError(
                "prior v18 staged or archived full app manifest changed".to_owned(),
            ));
        }
        let staged_symlinks = symlink_target_manifest(&self.staged_app.path)?;
        let failed_symlinks = symlink_target_manifest(&self.failed_app.path)?;
        if sha256_bytes(staged_symlinks.as_bytes())? != PRIOR_V18_SYMLINK_TARGET_MANIFEST_SHA256
            || failed_symlinks != staged_symlinks
        {
            return Err(ControllerError(
                "prior v18 staged or archived symlink target changed".to_owned(),
            ));
        }
        let staged_xattrs = capture_tree_xattrs_until(
            &self.staged_app.path,
        ...
        if sha256_bytes(staged_xattrs.as_bytes())? != PRIOR_V18_STAGED_APP_XATTRS_SHA256
            || sha256_bytes(failed_xattrs.as_bytes())? != PRIOR_V18_FAILED_APP_XATTRS_SHA256
        {
            return Err(ControllerError(
                "prior v18 staged or archived app xattrs changed".to_owned(),
            ));
        }
        if staged_plist != failed_plist {
            return Err(ControllerError(
                "prior v18 archived plist differs from its staged artifact".to_owned(),
            ));
        }
...
fn validate_prior_v18_rolledback_retry(
    private_root: &PinnedDirectory,
) -> Result<PriorV18RetryGuard> {
    for residue in [
        PRIOR_V18_ACTIVE_TRANSACTION_PENDING_NAME,
        PRIOR_V18_ACTIVE_TRANSACTION_FINALIZING_NAME,
        PRIOR_V18_ACTIVE_TRANSACTION_LINEARIZED_NAME,
        ...
        {
            return Err(ControllerError(format!(
                "prior v18 active-pointer residue requires manual recovery: {residue}"
            )));
        }
    }
    let pointer =
        open_required_pinned_regular(private_root, PRIOR_V18_ACTIVE_TRANSACTION_NAME, 0o600)?;
    let pointer_bytes = read_opened_regular(
        &pointer,
        &private_root.path.join(PRIOR_V18_ACTIVE_TRANSACTION_NAME),
        0o600,
    )?;
    if pointer_bytes != PRIOR_V18_ACTIVE_RECORD
        || sha256_bytes(&pointer_bytes)? != PRIOR_V18_ACTIVE_SHA256
    {
        return Err(ControllerError(
            "prior v18 active pointer is not the exact reviewed record".to_owned(),
        ));
    }
    let evidence_path = parse_active_record(&pointer_bytes)?;
    if evidence_path != Path::new(PRIOR_V18_EVIDENCE_PATH) {
        return Err(ControllerError(
            "prior v18 active pointer resolved to unexpected evidence".to_owned(),
        ));
    }
    ...
    let records = evidence
        .try_open_directory_child("records", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v18 evidence lacks records".to_owned()))?;
    let legacy_snapshot = evidence
        .try_open_directory_child("legacy-snapshot", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v18 evidence lacks legacy snapshot".to_owned()))?;
    let failed_new = evidence
        .try_open_directory_child("failed-new", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v18 evidence lacks failed-new".to_owned()))?;
    let failed_app = failed_new
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v18 evidence lacks archived app".to_owned()))?;
    let staged = evidence
        .try_open_directory_child("staged", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| ControllerError("prior v18 evidence lacks staged directory".to_owned()))?;
    let staged_app = staged
        .try_open_directory_child("opensteamer Host.app", Some(effective_uid()), None)?
        .ok_or_else(|| ControllerError("prior v18 evidence lacks staged app".to_owned()))?;
    let source_export = evidence
        .try_open_directory_child("source-export", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v18 evidence lacks source export directory".to_owned())
        })?;
    let scratch = evidence
        .try_open_directory_child("swiftpm-scratch", Some(effective_uid()), Some(0o700))?
        .ok_or_else(|| {
            ControllerError("prior v18 evidence lacks SwiftPM scratch directory".to_owned())
        })?;
    let guard = PriorV18RetryGuard {
        journal: open_required_pinned_regular(&evidence, "journal.log", 0o600)?,
        result: open_required_pinned_regular(&records, "result.txt", 0o600)?,
        provenance: open_required_pinned_regular(&records, "provenance.txt", 0o600)?,
        legacy_manifest: open_required_pinned_regular(
...
fn start_new(
    ...
    prior_fields.extend(prior_v11.journal_fields());
...
struct RealForwardBackend<'a> {
    ...
    prior_v11: &'a PriorV11RetryGuard,
    prior_v12: &'a PriorV12RetryGuard,
    ...
    fn perform_effect(&mut self, effect: ForwardEffect) -> Result<()> {
        match effect {
            ...
            ForwardEffect::DisableLegacy => {
                ...
                self.prior_v11.revalidate(self.private_root)?;
                self.prior_v12.revalidate(self.private_root)?;
            ...
            ForwardEffect::BootstrapNew => {
                ...
                require_new_runtime_absent()?;
                self.checkpoint = Some(checkpoint_prelaunch_log()?);
            ...
            ForwardEffect::CheckpointGenerationLog => {
                ...
                let checkpoint = self.checkpoint.ok_or_else(|| {
                    ControllerError("forward engine lacks a prelaunch log checkpoint".to_owned())
                })?;
                verify_launch_generation(NEW_LABEL, NEW_EXECUTABLE, generation)?;
                revalidate_log_checkpoint(Path::new(ONLINE_LOG), &checkpoint)
            }
            ForwardEffect::ObserveFreshMarker => {
                let checkpoint = self.checkpoint.ok_or_else(|| {
...
fn require_fresh_retry_disk_headroom() -> Result<u64> {
    let available = available_bytes_for(Path::new(PRIVATE_ROOT))?
        .min(available_bytes_for(Path::new(APPLICATIONS_DIRECTORY))?);
    if available < MINIMUM_FRESH_RETRY_AVAILABLE_BYTES {
        return Err(ControllerError(format!(
            "fresh-retry disk headroom is {available} bytes, below the required {MINIMUM_FRESH_RETRY_AVAILABLE_BYTES} bytes"
        )));
    }
    Ok(available)
}
...
fn verify_precutover(layout: &Layout, verifiers: &PinnedVerifierSet) -> Result<CutoverPreflight> {
    ...
    let deployment_zsh_runtime = run_pinned_script(
        verifiers,
        &verifiers.deployment,
        &[OsStr::new("--self-test-zsh-runtime")],
        Some(&layout.source_export),
        &environment,
    )?
    .require_success("deployment zsh-runtime self-test")?;
    if deployment_zsh_runtime.trim() != "SELF_TEST_OK zsh-runtime" {
        return Err(ControllerError(
            "deployment zsh-runtime self-test returned unexpected output".to_owned(),
        ));
    }
    verify_legacy_static()?;
...
fn verify_committed_destinations(layout: &Layout, verifiers: &PinnedVerifierSet) -> Result<()> {
    ...
    if directory_manifest(&layout.staged_app)? != directory_manifest(Path::new(NEW_APP))?
        || symlink_target_manifest(&layout.staged_app)?
            != symlink_target_manifest(Path::new(NEW_APP))?
    {
        return Err(ControllerError(
...
fn verify_deployment_with_prefix_until(
    ...
    require_before_deadline(deadline, "deployment verifier setup")?;
    ...
    require_before_deadline(deadline, "deployment verifier record publication")?;
    ...
    fn perform(&mut self, operation: CommittedRecoveryOperation) -> Result<Vec<(String, String)>> {
        match operation {
            ...
            CommittedRecoveryOperation::CheckpointCurrentGeneration => {
                ...
                let checkpoint = self.checkpoint.ok_or_else(|| {
                    ControllerError(
                        "committed recovery lacks a prelaunch log checkpoint".to_owned(),
                    )
                })?;
                verify_launch_generation(NEW_LABEL, NEW_EXECUTABLE, generation)?;
                revalidate_log_checkpoint(Path::new(ONLINE_LOG), &checkpoint)?;
    ...
    let operation = (|| -> Result<()> {
        ...
        if entry_exists(evidence)? {
            ...
            if directory_manifest(hidden)? != directory_manifest(evidence)?
                || symlink_target_manifest(hidden)? != symlink_target_manifest(evidence)?
            {
                return Err(ControllerError(format!(
...
fn capture_legacy_xattrs_until(deadline: Instant) -> Result<String> {
    capture_tree_xattrs_until(Path::new(LEGACY_APP), deadline)
}

fn capture_tree_xattrs_until(root: &Path, deadline: Instant) -> Result<String> {
    let arguments = [OsStr::new("-lr"), root.as_os_str()];
    run_command_until(Path::new("/usr/bin/xattr"), &arguments, None, deadline)?
        .require_success("app-tree xattr capture")
}
...
fn valid_process_start_identity(value: &str) -> bool {
    ...
    if !value.is_ascii() || value.len() != 24 {
        return false;
    }
    ...
    if bytes[3] != b' '
        ...
        || !MONTHS.contains(&&value[4..7])
    {
        return false;
    }
    let day_is_valid = matches!(
        (bytes[8], bytes[9]),
        (b' ', b'1'..=b'9') | (b'1' | b'2', b'0'..=b'9') | (b'3', b'0' | b'1')
    );
    let two_digits = |offset: usize| -> Option<u8> {
        let tens = bytes[offset].checked_sub(b'0')?;
        let ones = bytes[offset + 1].checked_sub(b'0')?;
        (tens <= 9 && ones <= 9).then_some(tens * 10 + ones)
    };
    day_is_valid
        && two_digits(11).is_some_and(|hour| hour <= 23)
        && two_digits(14).is_some_and(|minute| minute <= 59)
        && two_digits(17).is_some_and(|second| second <= 60)
...
fn process_start_identity_until(pid: u32, deadline: Instant) -> Result<String> {
    ...
    if !valid_process_start_identity(values[0]) {
        return Err(ControllerError(
            "process start identity is not one canonical C-locale lstart record".to_owned(),
        ));
    }
...
fn checkpoint_prelaunch_log() -> Result<LogCheckpoint> {
    safe_log_size(Path::new(ONLINE_LOG))
}
...
fn revalidate_log_checkpoint(path: &Path, checkpoint: &LogCheckpoint) -> Result<()> {
    let current = safe_log_size(path)?;
    if current.device != checkpoint.device
        || current.inode != checkpoint.inode
        || current.offset < checkpoint.offset
    {
        return Err(ControllerError(
            "online log was replaced or truncated after the prelaunch checkpoint".to_owned(),
        ));
    }
    Ok(())
}
...
fn symlink_target_manifest_until(root: &Path, deadline: Instant) -> Result<String> {
    let output = run_command_until(
        Path::new("/usr/bin/find"),
        &[
            root.as_os_str(),
    ...
    .require_success("symlink-target enumeration")?;
    let mut paths: Vec<&str> = output.lines().collect();
    paths.sort_unstable();
    let mut manifest = String::new();
    for path_text in paths {
        require_before_deadline(deadline, "symlink-target manifest")?;
        let path = Path::new(path_text);
        let metadata = fs::symlink_metadata(path)?;
        if !metadata.file_type().is_symlink() {
            return Err(ControllerError(format!(
                "symlink-target enumeration returned a non-symlink: {}",
                path.display()
            )));
        }
        let relative = path
            .strip_prefix(root)
            .map_err(|_| ControllerError("symlink escaped its app root".to_owned()))?
            .to_str()
            .ok_or_else(|| ControllerError("symlink path is not UTF-8".to_owned()))?;
        let target = fs::read_link(path)?;
        let target = target
            .to_str()
            .ok_or_else(|| ControllerError("symlink target is not UTF-8".to_owned()))?;
        ...
        {
            return Err(ControllerError(
                "symlink path or target contains an ambiguous manifest delimiter".to_owned(),
            ));
        }
...
fn symlink_target_manifest(root: &Path) -> Result<String> {
    symlink_target_manifest_until(root, deadline_after(DEFAULT_COMMAND_TIMEOUT)?)
}
    ...
    fn perform_effect(&mut self, effect: ForwardEffect) -> Result<()> {
        ...
        match effect {
            ...
            ForwardEffect::BootstrapNew => {
                ...
                self.world.checkpoint_generation = Some(self.world.generation + 1);
                self.world.marker_generation = None;
                self.world.stable_generation = None;
            ...
            ForwardEffect::CheckpointGenerationLog => {
                ...
                if self.world.checkpoint_generation != Some(self.world.generation) {
                    return Err(ControllerError(
                        "fake prelaunch checkpoint does not precede the observed process"
                            .to_owned(),
                    ));
                }
            }
    ...
    fn perform(&mut self, operation: CommittedRecoveryOperation) -> Result<Vec<(String, String)>> {
        let fields = match operation {
            ...
            CommittedRecoveryOperation::CheckpointCurrentGeneration => {
                ...
                if self.world.checkpoint_generation != Some(self.world.generation) {
                    return Err(ControllerError(
                        "fake committed prelaunch checkpoint does not precede the observed generation"
                            .to_owned(),
                    ));
                }
...
fn self_test_parsers() -> Result<()> {
    ...
    for valid in ["Sun Aug  2 16:35:42 2026", "Mon Dec 31 23:59:60 2026"] {
        if !valid_process_start_identity(valid) {
            return Err(ControllerError(format!(
                "process-start parser rejected canonical fixture: {valid}"
            )));
        }
    }
    for malformed in [
        ...
        "Sun Aug  2 24:35:42 2026",
        "Sun Aug  2 16:60:42 2026",
        "Sun Aug  0 16:35:42 2026",
        "Sun Xxx  2 16:35:42 2026",
    ] {
        if valid_process_start_identity(malformed) {
            return Err(ControllerError(format!(
                "process-start parser accepted malformed fixture: {malformed}"
            )));
        }
    }
...
fn self_test_command_deadlines() -> Result<()> {
    ...
    let expired_deadline = Instant::now()
        ...
        .ok_or_else(|| {
            ControllerError("deadline-edge could not construct an expired deadline".to_owned())
        })?;
    let deadline_edge = run_command_until(Path::new("/bin/true"), &[], None, expired_deadline)
        .expect_err("deadline-edge unexpectedly started a child")
        .to_string();
    if !deadline_edge.contains("exceeded its monotonic deadline budget")
        || !deadline_edge.contains("not-started")
    {
        return Err(ControllerError(format!(
            "deadline-edge did not return the canonical timeout diagnostic: {deadline_edge}"
        )));
    }
    ...
    for label in [
        ...
        if !error.contains("exceeded its monotonic deadline budget")
            || error.starts_with("timed-out child stdout exceeded")
            || error.starts_with("timed-out child stderr exceeded")
        {
            return Err(ControllerError(format!(
                "{label} timeout diagnostic was masked: {error}"
            )));
        }
    ...
    let output_flood_script = r#"
trap '' TERM
while :; do
  printf 'stdout-flood-0123456789\n'
  printf 'stderr-flood-0123456789\n' >&2
  /bin/sleep 0.01
done
"#;
    let output_flood = run_command_until(
        Path::new("/bin/sh"),
        &[OsStr::new("-c"), OsStr::new(output_flood_script)],
        None,
        deadline_after(Duration::from_millis(350))?,
    )
    .expect_err("output-flood unexpectedly completed")
    .to_string();
    if !output_flood.contains("exceeded its monotonic deadline budget")
        || !output_flood.contains("stdout_bytes=")
        || !output_flood.contains("stderr-flood")
        || output_flood.contains("child stdout exceeded its shared monotonic deadline")
        || output_flood.contains("child stderr exceeded its shared monotonic deadline")
    {
        return Err(ControllerError(format!(
            "output-flood did not preserve fair drains and canonical timeout classification: {output_flood}"
        )));
    }

    if DEFAULT_COMMAND_TIMEOUT != Duration::from_secs(60)
        || DEPLOYMENT_VERIFIER_TIMEOUT != Duration::from_secs(180)
        || DEPLOYMENT_VERIFIER_TIMEOUT <= DEFAULT_COMMAND_TIMEOUT
        || MINIMUM_FRESH_RETRY_AVAILABLE_BYTES != 2 * 1024 * 1024 * 1024
        || MINIMUM_PRECUTOVER_AVAILABLE_BYTES != 1024 * 1024 * 1024
        || MINIMUM_FRESH_RETRY_AVAILABLE_BYTES <= MINIMUM_PRECUTOVER_AVAILABLE_BYTES
    {
        return Err(ControllerError(
            "deployment timeout or migration disk-headroom constants differ from review".to_owned(),
        ));
    }
    let scaled_script = "/bin/sleep 0.15; printf 'deployment-timeout-model\\n'";
    let scaled_short = run_command_until(
        Path::new("/bin/sh"),
        &[OsStr::new("-c"), OsStr::new(scaled_script)],
        None,
        deadline_after(Duration::from_millis(80))?,
    );
    if scaled_short.is_ok() {
        return Err(ControllerError(
            "scaled default-budget deployment model false-passed".to_owned(),
        ));
    }
    let scaled_long = run_command_until(
        Path::new("/bin/sh"),
        &[OsStr::new("-c"), OsStr::new(scaled_script)],
        None,
        deadline_after(Duration::from_secs(1))?,
    )?
    .require_success("scaled dedicated deployment budget")?;
    if scaled_long.trim() != "deployment-timeout-model" {
        return Err(ControllerError(
            "scaled dedicated deployment budget returned unexpected output".to_owned(),
        ));
    }
    ...
    {
        return Err(ControllerError(
            "inherited-pipe nonblocking output collection waited for a descendant".to_owned(),
        ));
    }

    let total_deployment_started = Instant::now();
    let total_deployment_deadline = deadline_after(Duration::from_millis(350))?;
    run_command_until(
        Path::new("/bin/sh"),
        &[OsStr::new("-c"), OsStr::new("/bin/sleep 0.20")],
        None,
        total_deployment_deadline,
    )?
    .require_success("total-deployment-deadline first phase")?;
    let total_deployment_second = run_command_until(
        Path::new("/bin/sh"),
        &[OsStr::new("-c"), OsStr::new("/bin/sleep 0.20")],
        None,
        total_deployment_deadline,
    );
    if total_deployment_second.is_ok()
        || total_deployment_started.elapsed() > Duration::from_secs(2)
    {
        return Err(ControllerError(
            "total-deployment-deadline allowed sequential phases to manufacture fresh budgets"
                .to_owned(),
        ));
    }
...
fn self_test_embedded_zsh_verifiers() -> Result<()> {
    let directory = TemporaryDirectory::create("embedded-zsh-verifiers")?;
    let macos = directory.path.join("macOS");
    let scripts = macos.join("scripts");
    fs::create_dir(&macos)?;
    fs::create_dir(&scripts)?;
    let logical_path = scripts.join("verify-mac-host-deployment.sh");
    let script = std::str::from_utf8(EMBEDDED_DEPLOYMENT_VERIFIER).map_err(|_| {
        ControllerError("embedded deployment verifier is not valid UTF-8".to_owned())
    })?;
    let arguments = vec![
        "-c".to_owned(),
        script.to_owned(),
        logical_path.display().to_string(),
        "--self-test-zsh-runtime".to_owned(),
    ];
    let output = run_command_owned_until(
        Path::new("/bin/zsh"),
        &arguments,
        Some(&directory.path),
    ...
    if !output.status.success()
        || output.stdout != "SELF_TEST_OK zsh-runtime\n"
        || !output.stderr.is_empty()
    {
        return Err(ControllerError(format!(
            "embedded deployment zsh-runtime self-test failed: status={:?} stdout={:?} stderr={:?}",
            output.status.code(),
            output.stdout,
            output.stderr
        )));
...
fn run_self_test(case: &str) -> Result<()> {
    match case {
        ...
        "zsh-verifiers" => self_test_embedded_zsh_verifiers()?,
...
fn self_test_readiness() -> Result<()> {
    ...
    let mut fast_backend = FakeBackend::baseline();
    drive_forward(&mut fast_backend, &mut fast_journal, |_, _, _, _, _| Ok(()))?;
    if fast_backend.world.checkpoint_generation != Some(fast_backend.world.generation)
        || fast_backend.world.marker_generation != Some(fast_backend.world.generation)
        || fast_backend.world.stable_generation != Some(fast_backend.world.generation)
    {
        return Err(ControllerError(
            "fast-marker was lost or overwritten after synchronous bootstrap logging".to_owned(),
        ));
    }
...
fn self_test_prior_v18_retry_contract() -> Result<()> {
    validate_prior_v18_rolledback_records(
        Path::new(PRIOR_V18_EVIDENCE_PATH),
        PRIOR_V18_FINAL_JOURNAL_FIXTURE,
        PRIOR_V18_FINAL_RESULT,
        PRIOR_V18_PROVENANCE,
        b"",
        PRIOR_V18_DEPLOYMENT_STDERR_FIXTURE,
    )?;
    if sha256_bytes(PRIOR_V18_ACTIVE_RECORD)? != PRIOR_V18_ACTIVE_SHA256
        || PRIOR_V18_FINAL_JOURNAL_FIXTURE.len() != PRIOR_V18_FINAL_JOURNAL_SIZE
        || PRIOR_V18_FINAL_JOURNAL_FIXTURE
            .iter()
            .filter(|byte| **byte == b'\n')
            .count()
            != PRIOR_V18_FINAL_JOURNAL_LINES
        || sha256_bytes(PRIOR_V18_FINAL_JOURNAL_FIXTURE)? != PRIOR_V18_FINAL_JOURNAL_SHA256
        || sha256_bytes(PRIOR_V18_FINAL_RESULT)? != PRIOR_V18_FINAL_RESULT_SHA256
        || sha256_bytes(PRIOR_V18_PROVENANCE)? != PRIOR_V18_PROVENANCE_SHA256
        || PRIOR_V18_DEPLOYMENT_STDERR_FIXTURE.len() != PRIOR_V18_DEPLOYMENT_STDERR_SIZE
        || sha256_bytes(PRIOR_V18_DEPLOYMENT_STDERR_FIXTURE)? != PRIOR_V18_DEPLOYMENT_STDERR_SHA256
    {
        return Err(ControllerError(
            "embedded prior v18 retry fixtures differ from their reviewed anchors".to_owned(),
        ));
    }

    let mut mutated_journal = PRIOR_V18_FINAL_JOURNAL_FIXTURE.to_vec();
    mutated_journal[0] ^= 1;
    let mut mutated_result = PRIOR_V18_FINAL_RESULT.to_vec();
    mutated_result.extend_from_slice(b"unexpected=true\n");
    let mut mutated_provenance = PRIOR_V18_PROVENANCE.to_vec();
    mutated_provenance.extend_from_slice(b"unexpected=true\n");
    let mut mutated_deployment_stderr = PRIOR_V18_DEPLOYMENT_STDERR_FIXTURE.to_vec();
    mutated_deployment_stderr[0] ^= 1;
    for accepted_mutation in [
        ...
        validate_prior_v18_rolledback_records(
            ...
            PRIOR_V18_PROVENANCE,
            b"",
            &mutated_deployment_stderr,
        )
        .is_ok(),
    ] {
        if accepted_mutation {
            return Err(ControllerError(
                "prior v18 retry contract accepted mutated evidence".to_owned(),
            ));
        }
    }
    Ok(())
...
fn self_test_journal() -> Result<()> {
    ...
    validate_prior_v11_rolledback_records(
        ...
        PRIOR_V11_FINAL_RESULT,
        PRIOR_V11_PROVENANCE,
    )?;
    let prior_v11_journal_path = directory.path.join("prior-v11-journal.log");
    let prior_v11_result_path = directory.path.join("prior-v11-result.txt");
    let prior_v11_provenance_path = directory.path.join("prior-v11-provenance.txt");
    write_record(&prior_v11_journal_path, PRIOR_V11_FINAL_JOURNAL, 0o600)?;
    write_record(&prior_v11_result_path, PRIOR_V11_FINAL_RESULT, 0o600)?;
    write_record(&prior_v11_provenance_path, PRIOR_V11_PROVENANCE, 0o600)?;
    if sha256_file(&prior_v11_journal_path)? != PRIOR_V11_FINAL_JOURNAL_SHA256
        || sha256_file(&prior_v11_result_path)? != PRIOR_V11_FINAL_RESULT_SHA256
        || sha256_file(&prior_v11_provenance_path)? != PRIOR_V11_PROVENANCE_SHA256
    {
        return Err(ControllerError(
            "embedded prior v11 retry records do not match their reviewed hashes".to_owned(),
        ));
    }
    let mut mutated_journal = PRIOR_V11_FINAL_JOURNAL.to_vec();
    mutated_journal.extend_from_slice(b"STATE READY_VERIFIED\n");
    let mut mutated_result = PRIOR_V11_FINAL_RESULT.to_vec();
    mutated_result.extend_from_slice(b"unexpected=true\n");
    let mut mutated_provenance = PRIOR_V11_PROVENANCE.to_vec();
    mutated_provenance.extend_from_slice(b"unexpected=true\n");
    for (evidence, journal, result, provenance) in [
        (
            Path::new(PRIOR_V10_EVIDENCE_PATH),
        ...
        if validate_prior_v11_rolledback_records(evidence, journal, result, provenance).is_ok() {
            return Err(ControllerError(
                "prior v11 retry contract accepted mutated evidence".to_owned(),
            ));
        }
    }
    ...
    validate_prior_v12_rolledback_records(
        ...
        PRIOR_V12_FINAL_RESULT,
        PRIOR_V12_PROVENANCE,
    )?;
    let prior_v12_journal_path = directory.path.join("prior-v12-journal.log");
    let prior_v12_result_path = directory.path.join("prior-v12-result.txt");
    let prior_v12_provenance_path = directory.path.join("prior-v12-provenance.txt");
    write_record(&prior_v12_journal_path, PRIOR_V12_FINAL_JOURNAL, 0o600)?;
    write_record(&prior_v12_result_path, PRIOR_V12_FINAL_RESULT, 0o600)?;
    write_record(&prior_v12_provenance_path, PRIOR_V12_PROVENANCE, 0o600)?;
    if sha256_file(&prior_v12_journal_path)? != PRIOR_V12_FINAL_JOURNAL_SHA256
        || sha256_file(&prior_v12_result_path)? != PRIOR_V12_FINAL_RESULT_SHA256
        || sha256_file(&prior_v12_provenance_path)? != PRIOR_V12_PROVENANCE_SHA256
    {
        return Err(ControllerError(
            "embedded prior v12 retry records do not match their reviewed hashes".to_owned(),
        ));
    }
    let mut mutated_journal = PRIOR_V12_FINAL_JOURNAL.to_vec();
    mutated_journal.extend_from_slice(b"STATE LEGACY_DISABLED\n");
    let mut mutated_result = PRIOR_V12_FINAL_RESULT.to_vec();
    mutated_result.extend_from_slice(b"unexpected=true\n");
    let mut mutated_provenance = PRIOR_V12_PROVENANCE.to_vec();
    mutated_provenance.extend_from_slice(b"unexpected=true\n");
    for (evidence, journal, result, provenance) in [
        (
            Path::new(PRIOR_V11_EVIDENCE_PATH),
        ...
        if validate_prior_v12_rolledback_records(evidence, journal, result, provenance).is_ok() {
            return Err(ControllerError(
                "prior v12 retry contract accepted mutated evidence".to_owned(),
            ));
        }
    }
    ...
    validate_prior_v13_rolledback_records(
        ...
        PRIOR_V13_FINAL_RESULT,
        PRIOR_V13_PROVENANCE,
    )?;
    let prior_v13_journal_path = directory.path.join("prior-v13-journal.log");
    let prior_v13_result_path = directory.path.join("prior-v13-result.txt");
    let prior_v13_provenance_path = directory.path.join("prior-v13-provenance.txt");
    let prior_v13_deployment_stderr_path = directory.path.join("prior-v13-deployment.stderr");
    write_record(&prior_v13_journal_path, PRIOR_V13_FINAL_JOURNAL, 0o600)?;
    write_record(&prior_v13_result_path, PRIOR_V13_FINAL_RESULT, 0o600)?;
    write_record(&prior_v13_provenance_path, PRIOR_V13_PROVENANCE, 0o600)?;
    write_record(
        &prior_v13_deployment_stderr_path,
        PRIOR_V13_DEPLOYMENT_STDERR,
        0o600,
    )?;
    if sha256_file(&prior_v13_journal_path)? != PRIOR_V13_FINAL_JOURNAL_SHA256
        || sha256_file(&prior_v13_result_path)? != PRIOR_V13_FINAL_RESULT_SHA256
        || sha256_file(&prior_v13_provenance_path)? != PRIOR_V13_PROVENANCE_SHA256
        || sha256_file(&prior_v13_deployment_stderr_path)? != PRIOR_V13_DEPLOYMENT_STDERR_SHA256
    {
        return Err(ControllerError(
            "embedded prior v13 retry records do not match their reviewed hashes".to_owned(),
        ));
    }
    let mut mutated_journal = PRIOR_V13_FINAL_JOURNAL.to_vec();
    mutated_journal.extend_from_slice(b"STATE READY_VERIFIED\n");
    let mut mutated_result = PRIOR_V13_FINAL_RESULT.to_vec();
    mutated_result.extend_from_slice(b"unexpected=true\n");
    let mut mutated_provenance = PRIOR_V13_PROVENANCE.to_vec();
    mutated_provenance.extend_from_slice(b"unexpected=true\n");
    for (evidence, journal, result, provenance) in [
        (
            Path::new(PRIOR_V12_EVIDENCE_PATH),
        ...
        if validate_prior_v13_rolledback_records(evidence, journal, result, provenance).is_ok() {
            return Err(ControllerError(
                "prior v13 retry contract accepted mutated evidence".to_owned(),
            ));
        }
    }
    ...
    let prior_v14_journal_path = directory.path.join("prior-v14-journal.log");
    let prior_v14_result_path = directory.path.join("prior-v14-result.txt");
    let prior_v14_provenance_path = directory.path.join("prior-v14-provenance.txt");
    let prior_v14_deployment_stderr_path = directory.path.join("prior-v14-deployment.stderr");
    write_record(&prior_v14_journal_path, PRIOR_V14_FINAL_JOURNAL, 0o600)?;
    write_record(&prior_v14_result_path, PRIOR_V14_FINAL_RESULT, 0o600)?;
    write_record(&prior_v14_provenance_path, PRIOR_V14_PROVENANCE, 0o600)?;
    write_record(
        &prior_v14_deployment_stderr_path,
        PRIOR_V14_DEPLOYMENT_STDERR,
        0o600,
    )?;
    if sha256_file(&prior_v14_journal_path)? != PRIOR_V14_FINAL_JOURNAL_SHA256
        || sha256_file(&prior_v14_result_path)? != PRIOR_V14_FINAL_RESULT_SHA256
        || sha256_file(&prior_v14_provenance_path)? != PRIOR_V14_PROVENANCE_SHA256
        || sha256_file(&prior_v14_deployment_stderr_path)? != PRIOR_V14_DEPLOYMENT_STDERR_SHA256
    {
        return Err(ControllerError(
            "embedded prior v14 retry records do not match their reviewed hashes".to_owned(),
        ));
    }
    let mut mutated_journal = PRIOR_V14_FINAL_JOURNAL.to_vec();
    mutated_journal.extend_from_slice(b"STATE READY_VERIFIED\n");
    let mut mutated_result = PRIOR_V14_FINAL_RESULT.to_vec();
    mutated_result.extend_from_slice(b"unexpected=true\n");
    let mut mutated_provenance = PRIOR_V14_PROVENANCE.to_vec();
    mutated_provenance.extend_from_slice(b"unexpected=true\n");
    for (evidence, journal, result, provenance) in [
        (
            Path::new(PRIOR_V13_EVIDENCE_PATH),
        ...
        if validate_prior_v14_rolledback_records(evidence, journal, result, provenance).is_ok() {
            return Err(ControllerError(
                "prior v14 retry contract accepted mutated evidence".to_owned(),
            ));
        }
    }
    Ok(())
