...
final class DiagnosticDriverV4UpdateContractTests: XCTestCase {
    ...
    private let launcherPath = "macOS/scripts/update-opensteamer-diagnostic-driver-v4.sh"
    ...
    func testV4NamespacesModesAndDedicatedReleaseCheckoutAreExact() throws {
        ...
        for token in [
            ...
            "/diagnostic-driver-updates-v4", "/active-diagnostic-driver-update-v4",
            "/diagnostic-driver-update-v4.lock", "/diagnostic-driver-controllers-v4",
            "/diagnostic-driver-bootstrap-v4.txt", "/diagnostic-driver-probes-v4",
        ] {
            XCTAssertTrue(freshConstants.contains(token), "missing fresh V4 token: \(token)")
        }
        for staleV2Token in [
            ...
            XCTAssertFalse(
                ...
                "fresh V4 constants retain stale V2 namespace: \(staleV2Token)"
            )
        }
    ...
    func testRetainedV1V2AndV3SourcesAndEvidenceRemainImmutable() throws {
    ...
    func testLauncherHasFreshV4PinsAndPureSelfTestOnly() throws {
        let controller = try source(controllerPath)
        let launcher = try source(launcherPath)
        ...
        XCTAssertTrue(launcher.contains("/reviewed/opensteamer-diagnostic-driver-v4"))
    ...
    func testPureControllerSelfTestPassesWithoutLiveModes() throws {
        ...
        process.arguments = ["--self-test-diagnostic-driver-v4-update"]
        ...
        XCTAssertEqual(output, "DIAGNOSTIC_DRIVER_V4_SELF_TEST_OK tests=112\n")
