...
UI_TEST_TIMEOUT_SECONDS=${AUDIOSTREAMER_BASELINE_UI_TEST_TIMEOUT_SECONDS:-600}
...
audiostreamer_require_positive_integer \
  AUDIOSTREAMER_BASELINE_UI_TEST_TIMEOUT_SECONDS \
...
audiostreamer_start_isolated_validation_process xcodebuild test \
  ...
  -only-testing:AudioStreamerUITests/PairedReconnectPhysicalUITests/testLegacyInstalledReleaseProductionBaselineHasSavedPair \
